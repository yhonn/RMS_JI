<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/Site.Master" CodeBehind="frm_contratosEntregables.aspx.vb" Inherits="RMS_APPROVAL.frm_contratosEntregables" %>
                    ...
                    <div class="form-group row">
                     ...
                     <div class="box-footer">
                        <telerik:RadButton ID="btn_salir" runat="server" Text="Salir" Width="100px" CausesValidation="false" CssClass="btn btn-sm pull-right">
                         ...
                         <telerik:RadButton ID="btn_guardar2" runat="server" Text="Guardar e iniciar ejecución" AutoPostBack="true" CssClass="btn btn-sm pull-right margin-r-5">
                        </telerik:RadButton>
