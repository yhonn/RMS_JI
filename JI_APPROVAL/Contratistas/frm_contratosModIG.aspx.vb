...
Imports ly_APPROVAL
Public Class frm_contratosModIG
    ...
    Sub LoadData()
        Using dbEntities As New dbRMS_JIEntities
            ...
            Dim id_modificacion = Convert.ToInt32(Me.Request.QueryString("id"))
            Me.idModificacion.Value = id_modificacion

            Me.anchorBillable.Attributes.Add("class", "btn btn-success btn-circle")
            Me.anchorBillable.Attributes.Add("href", "frm_contratosModEntregables.aspx?ID=" & id_modificacion)

            Me.anchorMod.Attributes.Add("class", "btn btn-success btn-circle")
            Me.anchorMod.Attributes.Add("href", "frm_contratosModAd.aspx?ID=" & id_modificacion)
            ...
            Dim oContrato = modificacion.tme_contratos
    ...
    Private Sub btn_guardar_Click(sender As Object, e As EventArgs) Handles btn_guardar.Click
        Try
            ...
            Using dbEntities As New dbRMS_JIEntities
                ...
                Me.MsgGuardar.Redireccion = "~/contratistas/frm_contratosModEntregables?id=" & id_modificacion
