<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/Site.Master" CodeBehind="frm_entregableProducto.aspx.vb" Inherits="RMS_APPROVAL.frm_entregableProducto" %>
                        ...
                        <div class="stepwizard">
                            <div class="stepwizard-row setup-panel">
                                <div class="stepwizard-step" style="width:50%">
                                    <a href="#step-1" id="anchorInformation" runat="server" type="button" class="btn btn-default btn-circle">1</a>
                                    <p>
                                        <asp:Label runat="server" ID="lblt_informaciongeneral">Información general</asp:Label>
                                    </p>
                                </div>
                                <div class="stepwizard-step" style="width:50%">
                                    <a   href="#step-2" id="anchorBillable" runat="server" type="button" class="btn btn-primary btn-circle">2</a>
                                    <p>
                                        ...
                                        <MasterTableView AutoGenerateColumns="False" DataKeyNames="id_contrato_entregable" AllowAutomaticUpdates="True" >
                                            <Columns>
                                                ...
                                                <telerik:GridBoundColumn DataField="numero_entregable"
                                                    FilterControlAltText="Filter numero_entregable column" HeaderStyle-Width="19%"
                                                ...
                                                <telerik:GridBoundColumn DataField="nombre_entregable"
                                                    FilterControlAltText="Filter nombre_entregable column" HeaderStyle-Width="37%"
                                                ...
                                                <telerik:GridBoundColumn DataField="fecha_esperada_entrega"  DataFormatString="{0:MM/dd/yyyy}"
                                                    FilterControlAltText="Filter fecha_esperada_entrega column" HeaderStyle-Width="19%"
                                                ...
                                                <telerik:GridBoundColumn DataField="dias_restantes"
                                                    FilterControlAltText="Filter dias_restantes column" HeaderStyle-Width="19%"
                                                ...
                                                <telerik:GridBoundColumn DataField="estado"
                                                    FilterControlAltText="Filter estado column" HeaderStyle-Width="19%"
                                                    HeaderText="Estado" SortExpression="estado"
                                                    UniqueName="colm_estado">
                                                    <HeaderStyle CssClass="wrapWord"  />
                                                </telerik:GridBoundColumn>
                                                <telerik:GridBoundColumn DataField="numero_productos"
                                                    FilterControlAltText="Filter numero_productos column" HeaderStyle-Width="19%"
                                                    HeaderText="Nro productos" SortExpression="numero_productos"
                                                    UniqueName="colm_numero_productos">
                                                    <HeaderStyle CssClass="wrapWord"  />
                                                </telerik:GridBoundColumn>
