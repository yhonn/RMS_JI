<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/Site.Master" CodeBehind="frm_contratosAD.aspx.vb" Inherits="RMS_APPROVAL.frm_contratosAD" %>
    ...
    <section class="content">
        <div class="box">
            <div class="box-header with-border">
                <h3 class="box-title">
                    <asp:Label runat="server" ID="lblt_subtitulo_pantalla">Registrar contrato</asp:Label></h3>
                    ...
                    <div class="box-body">
                        <div class="stepwizard">
                            <div class="stepwizard-row setup-panel">
                                ...
                                <div class="stepwizard-step" style="width:50%">
                                    <a   href="#step-2" id="anchorBillable" runat="server" type="button" class="btn btn-default btn-circle disabled">2</a>
                                    <p>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="box-body">
                                <ul class="nav nav-tabs">
                                    <li class="active"><a data-toggle="tab" href="#Beneficiaries"><asp:Label runat="server" ID="lblt_beneficiaries" CssClass="control-label text-bold">Registro manual</asp:Label></a></li>                                    
                                    <li><a data-toggle="tab" href="#Upload"><asp:Label runat="server" ID="lblt_upload" CssClass="control-label text-bold">Cargue masivo</asp:Label></a></li>
                                </ul>

                                <div class="tab-content">
                                    <div id="Beneficiaries" class="tab-pane fade in active">
                                        <div class="form-group row">
                             ...
                             <div class="col-sm-12">
                                  <telerik:RadGrid ID="grd_componente" runat="server"  GridLines="None">
                                    ...
                                    <%--<MasterTableView AllowAutomaticDeletes="true" AutoGenerateColumns="False" CommandItemDisplay="None" 
                                      ...
                                      <GroupByExpressions>
                                        ...
                                        <div class="box-footer">
                                            ...
                                            <asp:Label ID="Label1" runat="server" CssClass="Error pull-right" Visible="False">* Complete campos</asp:Label>
                                        </div>
                                    ...
                                    <div id="Upload" class="tab-pane fade">
                                        <div class="form-group row">
                                            <div class="col-lg-12">
                                                <a href="frm_formatosxls.aspx?id=1" class="btn btn-primary btn-sm"><i class="fa fa-file-excel-o" aria-hidden="true"></i> Descargar formato</a>
                                            </div>
                                        </div>
                                        <div class="form-group row">
                                            <div class="col-sm-2">
                                                <asp:Label runat="server" ID="lblt_shape" CssClass="control-label text-bold">Cargar listado</asp:Label>
                                            </div>
                                            <div class="col-sm-5">
                                                <telerik:RadAsyncUpload 
                                                    RenderMode="Lightweight" 
                                                    ...
                                                    TemporaryFolder="~/Temp" 
                                                    HttpHandlerUrl="~/FileUploadTelerik/UploadImageHandler.ashx" 
                                                    PostbackTriggers="btn_cargar_contratos"
                                                     >
                                                </telerik:RadAsyncUpload>
                                            </div>
                                        </div>
                                        <div class="form-group row">
                                            <div class="col-sm-2">
                                               <telerik:RadButton ID="btn_cargar_contratos" runat="server" Text="Guardar y Continuar" Enabled="true" AutoPostBack="true" CssClass="btn btn-sm pull-right margin-r-5">
                                                </telerik:RadButton>
                                            </div>
                                        </div>
                                    </div>
