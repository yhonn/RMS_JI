...
Public Class frm_contratosEntregables
    Inherits System.Web.UI.Page
    Dim cl_user As ly_SIME.CORE.cls_user
    Dim cl_error As New ly_SIME.CORE.ErrorHandler
    Dim frmCODE As String = "ADM_CONT_ENTRE"
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        If Not Me.IsPostBack Then
            ...
            Me.anchorInformation.Attributes.Add("href", "frm_contratosEdit.aspx?ID=" & Me.idContrato.Value)
            fillGrid()
            loadData()
        End If
    ...
    Private Sub btn_guardar2_Click(sender As Object, e As EventArgs) Handles btn_guardar2.Click
        ...
        Using dbEntities As New dbRMS_JIEntities
            Dim contrato = dbEntities.tme_contratos.Find(id_contrato)
            contrato.id_estado_contrato = 2
            dbEntities.Entry(contrato).State = Entity.EntityState.Modified
            dbEntities.SaveChanges()
        End Using
        Me.MsgGuardar.NuevoMensaje = cl_user.controles_otros.FirstOrDefault(Function(p) p.control_code = "GUARDADO").texto
        Me.MsgGuardar.Redireccion = "~/contratistas/frm_contratos"
