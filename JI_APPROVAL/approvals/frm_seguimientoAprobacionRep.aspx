<%@ Page Language="VB" AutoEventWireup="false" MasterPageFile="~/MasterPopUp.Master"  Inherits="RMS_APPROVAL.frm_seguimientoAprobacionRep" Codebehind="frm_seguimientoAprobacionRep.aspx.vb" %>
                            ...
                            <tr>
                             ...
                             <tr>
                               ...
                               <tr>
                                ...
                                <td><!--Control -->
                                    <asp:Label ID="lbl_dateapproved" runat="server"   CssClass="control-label text-bold"   ></asp:Label>
