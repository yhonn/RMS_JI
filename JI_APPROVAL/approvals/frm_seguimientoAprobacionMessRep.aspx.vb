...
Partial Class frm_seguimientoAprobacionMessRep
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        If Not IsPostBack Then
            ...
            'dValue = tbl_Doc.Rows.Item(0).Item("tasa_cambio")
            'Me.tbl_Doc.Rows.Item(0).Item("datecreated").Text = dValue.ToString("D2", cl_user.regionalizacionCulture)
            ...
            Me.rept_msgApproval.DataSource = clss_approval.get_Document_Comments_special(Me.lblIDocumento.Text)
