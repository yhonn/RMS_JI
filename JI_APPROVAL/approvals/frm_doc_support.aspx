<%@ Page Language="VB" MasterPageFile="~/Site.Master" AutoEventWireup="false" Inherits="RMS_APPROVAL.frm_doc_support"  Codebehind="frm_doc_support.aspx.vb" %>
     ...
     <section class="content">
            ...
            <div class="box">
             ...
             <div class="box-header with-border">
                <h3 class="box-title">
                    <asp:Label runat="server" ID="lblt_subtitulo_pantalla">New Document</asp:Label>
                </h3>
            </div>
            <div class="box-body">
                  <div class="col-lg-12">
                    <div class="box-body">
                           <div class="form-group row">
                            <div class="col-sm-2 text-left">
                                <asp:Label ID="lblt_Nombre_Documento" runat="server" CssClass="control-label text-bold" Text="Document Name"></asp:Label>
                            </div>
                            <div class="col-sm-8">
                                <telerik:RadTextBox ID="txt_cat" Runat="server" 
                                    EmptyMessage="Type Document name here.." LabelWidth="" Width="70%"  ValidationGroup="1">
                           ...
                           <div class="form-group row">
                            ...
                            <div class="col-sm-8">
                               <asp:CheckBoxList ID="chk_ext" runat="server" RepeatColumns="3" Width="185px" 
                                ...
                                <asp:Label ID="lblt_errExt" runat="server" ForeColor="Red" Text="Required" CssClass="btn btn-sm pull-left"
                      ...
                      <div class="box-body">
                        ...
                        <div class="box-footer">                            
                            ...
                            <span>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</span>
                             ...
                             <telerik:RadButton ID="btn_cancel" runat="server"  SingleClick="true" SingleClickText="Processing..." Text="Cancel" Width="100px" CausesValidation="false" ValidationGroup="2" CssClass="btn btn-sm pull-left">
                            </telerik:RadButton>
