<%@ Page Language="VB" MasterPageFile="~/Site.Master" AutoEventWireup="false" Inherits="RMS_APPROVAL.frm_rolesSH_edit" Codebehind="frm_rolesSH_edit.aspx.vb" %>
            ...
            <section class="content">
                <div class="box">
                     <div class="box-header with-border">
                        <h3 class="box-title">
                            <asp:Label runat="server" ID="lblt_subtitulo_pantalla">Edit Role (Shared)</asp:Label>
                        </h3>
                    </div>
                    <div class="box-body">
                          <div class="box-body">
                               ...
                               <div class="box-body">
                                   ...
                                   <div class="form-group row">
                                       ...
                                       <div class="col-sm-8 text-left">
                                           ...
                                           <asp:LinkButton ID="btnlk_addEmployeed" runat="server" AutoPostBack="True"  SingleClick="true" SingleClickText="Processing..." Text="Add Employee" Width="20%" CssClass="btn btn-sm btn-default " ValidationGroup="2"    >Add Employee <span class="glyphicon glyphicon-plus-sign"></span></asp:LinkButton> 
                                        ...
                                        <div class="col-sm-12 ">
                                           <!--Control -->
                                                  ...
                                                  <asp:Label ID="lblt_filerequeried" runat="server" Text="We don´t have more employes to relate at this role" ForeColor="Red" Visible="false"></asp:Label>
                                                   <hr />    
                                                 <asp:Label ID="lblt_requeired" runat="server" Text="Required" Visible="false"></asp:Label>
                                                            ...
                                                            <HeaderStyle Width="20px"></HeaderStyle>
                                                                ...
                                                                <Columns>                                              
                                                                      ...
                                                                      <telerik:GridTemplateColumn FilterControlAltText="Filter Remove User column" 
                                                                                                            UniqueName="colm_remove" Visible="false">
                                                                                                            <ItemTemplate>

                                                                                                                <asp:CheckBox ID="chkRemove" runat="server" AutoPostBack="True" ToolTip="Remove from this role" />

                                                                                                                 <%--oncheckedchanged="chkRemove_CheckedChanged"  --%>

                                                                                                                <ajaxToolkit:ToggleButtonExtender ID="ToggleButtonExtender1" runat="server" 
                                                                                                                    CheckedImageUrl="~/Imagenes/iconos/icon-warningAlert.png" 
                                                                                                                    UncheckedImageUrl="~/Imagenes/iconos/b_drop.png"
                                                                                                                    ImageHeight="16" ImageWidth="16"  
                                                                                                                    TargetControlID="chkRemove" >
