...
Partial Class frm_seguimientoAprobacionEnvironmental
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        If Not IsPostBack Then
            ...
            'Dim Sql = "SELECT *,dbo.UsuarioResponsable(IdOriginador) AS Originador,dbo.UsuarioResponsable(IdUserOwnerUniq) AS propietario, dbo.FN_ta_getFechaAprobacioRutaEstadoDoc(id_documento) as FechaAprobacion FROM vw_ta_documentos WHERE id_documento=" & Me.lblIDocumento.Text
