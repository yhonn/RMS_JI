<%@ Page Language="VB" MasterPageFile="~/Site.Master" AutoEventWireup="false" Inherits="RMS_APPROVAL.frm_groups_edit"  Codebehind="frm_groups_edit.aspx.vb" %>
            ...
            <section class="content">
                <div class="box">
                     <div class="box-header with-border">
                        <h3 class="box-title">
                            <asp:Label runat="server" ID="lblt_subtitulo_pantalla">Edit Group</asp:Label>
                        </h3>
                    </div>
                    <div class="box-body">
                          <div class="box-body">
                            <div class="col-lg-12">
                               <div class="box-body">
                                    <div class="form-group row">
                                       ...
                                       <div class="col-sm-8">
                                           <!--Control -->
                                             <telerik:RadComboBox ID="cmb_rol" Runat="server" CausesValidation="False" 
                                               DataTextField="nombre_rol" DataValueField="id_rol" Width="350px" AutoPostBack="True">
                                                    <WebServiceSettings>
                                   ...
                                   <div class="form-group row">
                                    ...
                                    <div class="form-group row">
                                        <div class="col-sm-2 text-left">
                                         <!--Tittle -->
                                            <asp:Label ID="lblt_group_name" runat="server" ssClass="control-label text-bold" Text="Group Name"></asp:Label>
                                        </div>
                                       <div class="col-sm-8">
                                           <!--Control -->
                                   ...
                                   <div class="form-group row">
                                        <div class="col-sm-2 text-left">
                                         <!--Tittle -->
                                          <asp:Label ID="lblt_description" runat="server" ssClass="control-label text-bold" Text="Description"></asp:Label>
                                        </div>
                                       <div class="col-sm-8">
                                           <!--Control -->
                                   ...
                                   <div class="form-group row">
                                        <div class="col-sm-2 text-left">
                                         <!--Tittle -->
                                             <asp:Label ID="lblt_employee_member" runat="server" ssClass="control-label text-bold" Text="Employee Member"></asp:Label>
                                        </div>
                                       <div class="col-sm-10">
                                           <!--Control -->
                                             ...
                                             <telerik:RadComboBox ID="cmb_usu" 
                                              ...
                                              <asp:LinkButton ID="bntlk_add_employee" runat="server" AutoPostBack="True" Width="20%"  CssClass="btn btn-sm btn-default "  ValidationGroup="2"   >Add Member <span class="glyphicon glyphicon-plus-sign"></span></asp:LinkButton> 
                                                ...
                                                <asp:SqlDataSource ID="SqlDataSource2" runat="server" ConnectionString="<%$ ConnectionStrings:dbCI_SAPConnectionString %>"  ProviderName="<%$ ConnectionStrings:dbCI_SAPConnectionString.ProviderName %>" 
                                                    SelectCommand="SELECT id_usuario, nombre_usuario as nombre_empleado, estado  FROM vw_t_usuarios WHERE (id_usuario NOT IN (SELECT id_usuario FROM ta_gruposRoles WHERE id_grupo = @id_temp)) AND (id_programa = @id_program) AND (id_usuario <> @id_usuario)  AND (estado = 'ACTIVE' or estado = 'ACTIVO')">                                                        
                                                    <SelectParameters>
                                                            <asp:SessionParameter Name="id_program" SessionField="E_IDPrograma" 
                                                                DefaultValue="-1" />
                                     ...
                                     <div class="form-group row">
                                         ...
                                         <div class="col-sm-2 text-left">
                                         <!--Tittle -->                                             
                                             <asp:Label ID="lblt_memebre_list" runat="server" ssClass="control-label text-bold" Text="Members List"></asp:Label>
                                        </div>
                                                ...
                                                <telerik:RadGrid ID="grd_cate"  Skin="Office2010Blue"   runat="server" AllowAutomaticDeletes="True" 
                                                 CellSpacing="0" GridLines="None" Width="80%" AutoGenerateColumns="False" AllowAutomaticUpdates="True" DataSourceID="SqlDataSource3">
                                                    ...
                                                    <Selecting AllowRowSelect="True"></Selecting>
                                                     ...
                                                     <MasterTableView AutoGenerateColumns="False"  DataKeyNames="id_grupoRol"  DataSourceID="SqlDataSource3">
                                                        ...
                                                        <HeaderStyle Width="20px"></HeaderStyle>
                                                            ...
                                                            <telerik:GridButtonColumn ConfirmText="Confirm delete this element?" ConfirmDialogType="RadWindow"
                                                                    ...
                                                                    CommandName="Delete" ConfirmDialogHeight="100px"
                                                                                    ConfirmDialogWidth="400px" UniqueName="colm_ELIMINAR" 
                                                                ...
                                                                <telerik:GridTemplateColumn FilterControlAltText="Filter Orden column" 
                                                                 ...
                                                                 <telerik:GridBoundColumn DataField="id_grupoRol" FilterControlAltText="Filter id column"  SortExpression="id_grupoRol" UniqueName="id_grupoRol" Visible="true" Display ="false">
                                                                 </telerik:GridBoundColumn>
                                                 ...
                                                 <asp:SqlDataSource ID="SqlDataSource3" runat="server" ConnectionString="<%$ ConnectionStrings:dbCI_SAPConnectionString %>"  ProviderName="<%$ ConnectionStrings:dbCI_SAPConnectionString.ProviderName %>" 
                                                         ...
                                                         SelectCommand="SELECT a.id_grupo,a.id_rol, a.id_usuario, a.aprueba, a.comenta, a.consulta, b.nombre_usuario + ' ' + b.apellidos_usuario  AS nombre_empleado, c.nombre_rol, a.id_grupoRol 
	                                                                     FROM ta_gruposRoles a 
		                                                                    inner join  t_usuarios b on (a.id_usuario = b.id_usuario) 
		                                                                     inner join ta_roles c on (c.id_rol = a.id_rol)  
		                                                                       WHERE id_grupo = @id_temp " 

                                                         DeleteCommand="DELETE FROM ta_gruposRoles WHERE id_grupoRol=@id_temp">
                                                        <SelectParameters>
                                                            <asp:ControlParameter ControlID="lbl_idTemp" DefaultValue="-1" Name="id_temp" 
                                                                PropertyName="Text" />
                                                        </SelectParameters>
                   ...
                   <div class="box-footer">                            
                        <!--Controls -->
                       <telerik:RadButton ID="btn_save"  SingleClick="true" SingleClickText="Processing..." runat="server" Text=" Save " ValidationGroup="1" CssClass="btn btn-sm pull-left" Width="100" enabled="false"></telerik:RadButton>
                        <span>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</span>
                        <telerik:RadButton ID="btn_cancel"  SingleClick="true" SingleClickText="Processing..."  runat="server"  Text=" Cancel " CssClass="btn btn-sm pull-left" Width="100"></telerik:RadButton>                       
                        &nbsp;&nbsp;
                   </div>
