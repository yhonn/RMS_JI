<%@ Page Language="VB" MasterPageFile="~/Site.Master" AutoEventWireup="false" Inherits="RMS_APPROVAL.frm_categorias" Codebehind="frm_categorias.aspx.vb" %>
         ...
         <div class="box">
             <div class="box-header with-border">
               ...
               <div class="box-body">
                        ...
                        <telerik:RadButton ID="btn_nuevo" runat="server"  SingleClick="true" SingleClickText="Processing..."  Text="New Type" Enabled="false" Visible="false" >
                        </telerik:RadButton>                      
                        <telerik:RadButton ID="RadButton1" runat="server"  SingleClick="true" SingleClickText="Processing..."  Text="testing" Enabled="true" Visible="true" >
                        </telerik:RadButton>
                       ...
                       <hr />
                        ...
                        <asp:Label ID="Label3" runat="server" Text="**  Field required"></asp:Label><br />
                        <asp:Label ID="lbl_Error" runat="server" Text="Error saving the categorie" ForeColor="Red" Visible="false"></asp:Label>
