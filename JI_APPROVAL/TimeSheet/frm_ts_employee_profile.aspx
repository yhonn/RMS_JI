<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/Site.Master" CodeBehind="frm_ts_employee_profile.aspx.vb" Inherits="RMS_APPROVAL.frm_ts_employee_profile" %>
    ...
    <section class="content">
        <div class="box">
            <div class="box-header with-border">
                <h3 class="box-title">
                    <asp:Label runat="server" ID="lblt_subtitulo_pantalla">Perfil de Empleado</asp:Label></h3>
            </div>
            <div class="box-body">
                                                ...
                                                <div class="col-md-8 text-left">
                                                        ...
                                                        <asp:Label ID="lblt_cargo" runat="server" CssClass="control-label text-bold" Text="Job Title"></asp:Label>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                                                          <telerik:RadComboBox ID="cmb_job_title" 
                                                           ...
                                                           <asp:Label ID="lblt_nombre_usuario" runat="server" CssClass="control-label text-bold" Text="Name"></asp:Label>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;

                                                            <telerik:RadTextBox ID="txt_nombreUsuario" runat="server" Rows="3" TextMode="SingleLine" Width="350px" MaxLength="250" ReadOnly="true">
                                                            </telerik:RadTextBox>
                                                         ...
                                                         <asp:Label ID="lblt_apellido_usuario" runat="server" CssClass="control-label text-bold" Text="Last Name"></asp:Label>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;

                                                            <telerik:RadTextBox ID="txt_apellidos" runat="server" Rows="3" Width="350px" ReadOnly="true"
                                                                MaxLength="250">
                                                            </telerik:RadTextBox>
                                                       ...
                                                       <asp:Label ID="lblt_documento" runat="server" CssClass="control-label text-bold" Text="ID"></asp:Label>&nbsp;&nbsp;&nbsp;
                                                        <telerik:RadTextBox ID="txt_documento" runat="server" Rows="3" Width="350px" Text="" MaxLength="50" ReadOnly="true" >
                                                            </telerik:RadTextBox>
                                                     ...
                                                     <telerik:RadTextBox ID="txt_email_usuario" runat="server" MaxLength="100" Width="250px" ReadOnly="true">
                                                     </telerik:RadTextBox>
                              ...
                              <asp:HiddenField ID="TabName" runat="server" Value="Employees" />
                                   ...
                                   <div class="p-0 pt-1" id="Tabs">          
                                       ...
                                       <ul class="nav nav-tabs">
                                           <li class="active"><a data-toggle="tab" href="#Employees"><asp:Label runat="server" ID="lblt_Employees" CssClass="control-label text-bold">Profile</asp:Label></a></li>                                    
                                           ...
                                           <li><a data-toggle="tab" href="#Cassual"><asp:Label runat="server" ID="lblt_cassual" CssClass="control-label text-bold">Casual Leave / Sick Leave</asp:Label></a></li>
                                      ...
                                      <div id="Employees" class="tab-pane fade in active">
			                                        ...
			                                        <%--***********REGISTER EMPLOYEES***********--%>
                                                     ...
                                                     <br /><br />
                                                              <div class="form-group row">                                        
                                                                ...
                                                                <div class="col-md-3 text-left">                                                      
                                                                 ...
                                                                 <div class="col-md-1 text-left">
                                                                      <asp:Label ID="lblt_birth_day" runat="server" CssClass="control-label text-bold" Text="Birth Date"></asp:Label>
                                                                 </div>
                                                                 <div class="col-md-3 text-left">  
                                                                      <telerik:RadDatePicker ID="dt_birth_day" runat="server" MinDate="01/01/1940" Enabled="false" >
                                                            ...
                                                            <div class="form-group row">       
                                                                  ...
                                                                  <div class="col-md-1 text-left">
                                                                   ...
                                                                   <div class="col-md-8 text-left">                                                                                
                                                                           ...
                                                                           <asp:Label runat="server" ID="lbl_supervisorErr" CssClass="Error" Visible="false" Text="* Required"></asp:Label> &nbsp;&nbsp;&nbsp;
                                                           ...
                                                           <div class="form-group row">                                        
                                                            ...
                                                            <div class="col-md-3 text-left"> 
                                                                        <telerik:RadDatePicker ID="dt_fecha_contrato" runat="server" Enabled="false">
                                                                            <Calendar UseRowHeadersAsSelectors="False" UseColumnHeadersAsSelectors="False" ViewSelectorText="x"></Calendar>                                   
                                                                        </telerik:RadDatePicker>
                                                            ...
                                                            <div class="col-md-1 text-left">
                                                                <asp:Label ID="lblt_fecha_vence" runat="server" CssClass="control-label text-bold" Text="Expired Date"></asp:Label>                    
                                                            </div>
                                                            <div class="col-md-4 text-left">
                                                                  <telerik:RadDatePicker ID="dt_fecha_contrato_vence" runat="server" Enabled="false">
                                                                  <Calendar UseRowHeadersAsSelectors="False" UseColumnHeadersAsSelectors="False" ViewSelectorText="x"></Calendar>                                   
                                                                  </telerik:RadDatePicker>
                                                        ...
                                                        <div class="form-group row">                                        
                                                             ...
                                                             <div class="col-md-1 text-right">                       
                                                               ...
                                                               <asp:Label ID="lblt_Celular" runat="server" CssClass="control-label text-bold" Text="Mobile Number"></asp:Label>
                                                             </div>
                                                             <div class="col-md-3 text-left"> 
                                                                 <telerik:RadTextBox ID="txt_telefono" runat="server" MaxLength="100" Width="150px" ReadOnly="true">
                                                                 </telerik:RadTextBox><br /><br />
                                                                 <telerik:RadTextBox ID="txt_mobile" runat="server" MaxLength="100" Width="150px" ReadOnly="true">
                                                                 </telerik:RadTextBox>
                                                             </div>
                                                            <div class="col-md-1 text-left">
                                                            ...
                                                            <div class="col-md-4 text-left">
                                                                 <telerik:RadTextBox ID="txt_direccion" runat="server" MaxLength="200" TextMode="MultiLine"  Rows="4" Width="350px"  ReadOnly="true" >
                                                                 </telerik:RadTextBox>
                                                            </div>
                                              ...
                                              <div class="form-group row">             
                                                <hr style="color:gray;" />
                                                         ...
                                                         <div class="form-group row">                                        
                                                             <div class="col-md-1 text-right">
                                                                <asp:Label ID="lblt_salary" runat="server" CssClass="control-label text-bold" Text="Salary"></asp:Label>
                                                             </div>
                                                             <div class="col-md-3 text-left"> 
                                                               <telerik:RadNumericTextBox  runat="server" ID="txt_salary" Width="125px" Value="0" ReadOnly="true" >
                                                                    <NumberFormat DecimalDigits="2" />  
                                                               </telerik:RadNumericTextBox>
                                                             </div>
                                                            <div class="col-md-1 text-left">
                                                                 <asp:Label ID="lblt_worked_days" runat="server" CssClass="control-label text-bold" Text="">Migrated Days</asp:Label><br /><br />
                                                                 <asp:Label ID="lblt_exec_days" runat="server" CssClass="control-label text-bold" Text="">Worked Days</asp:Label>
                                                            </div>
                                                            <div class="col-md-4 text-left">
                                                              <telerik:RadNumericTextBox  runat="server" ID="txt_contract_days" Width="125px" Value="0"  ReadOnly="true">
                                                                    <NumberFormat  DecimalDigits="2" />  
                                                               </telerik:RadNumericTextBox><br /><br /><br />
                                                               <telerik:RadNumericTextBox  runat="server" ID="txt_worked_days" Width="125px" Value="0" Visible="false" >
                                                                    <NumberFormat  DecimalDigits="2" />  
                                                               </telerik:RadNumericTextBox >                       
                                                            </div>
                                                         </div>
                                                          ...
                                                          <div class="form-group row hidden">                                        
                                                             <div class="col-md-1 text-right">
                                                                <asp:Label ID="lblt_createdBy" runat="server" CssClass="control-label text-bold" Text="Create By"></asp:Label>
                                                             </div>
                                                             <div class="col-md-3 text-left"> 
                                   ...
                                   <div class="col-sm-12 text-left">
                                         ...
                                         <div class="box" style="border-top-color:lightgray">
                                                  <div class="box-header">
                                                      <h3 class="box-title"><asp:Label ID="lblt_vacationDetail" runat="server" CssClass="control-label text-bold" Text="Creado Por">Annual Leave Summary</asp:Label></h3>
                                                  </div><!-- /.box-header -->
                      ...
                      <div id="Cassual" class="tab-pane fade">
                            ...
                            <div class="form-group row">
                                   <div class="col-sm-12 text-left">
                                         ...
                                         <div class="box" style="border-top-color:lightgray">
                                                  <div class="box-header">
                                                      <h3 class="box-title"><asp:Label ID="lblt_cassual_t" runat="server" CssClass="control-label text-bold" >Cassual Leave / Sick Leave</asp:Label></h3>
                                                  </div><!-- /.box-header -->
                                                 <div class="box-body no-padding">
                                                                            <%--  <table class="table table-striped">
                                                                                <tr>
                                             ...
                                             <telerik:RadPivotGrid 
                                                      ...
                                                      ColumnHeaderZoneText="ColumnHeaderZone"  >
                                                        ...
                                                        <Fields>                                                                                                                    
                                                            ...
                                                            <telerik:PivotGridColumnField  DataField="FiscalYearNotation" Caption="Period" CellStyle-Height="35px"    CellStyle-Width="100px"  >
                                                            </telerik:PivotGridColumnField>
