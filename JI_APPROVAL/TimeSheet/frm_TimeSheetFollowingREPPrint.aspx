<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/MasterPopUp.Master" CodeBehind="frm_TimeSheetFollowingREPPrint.aspx.vb" Inherits="RMS_APPROVAL.frm_TimeSheetFollowingREPPrint" %>
                        ...
                        <div class="box-body row">                                                           
                            ...
                            <div class="col-lg-12 row">
                               <div class="box-body">
                                   ...
                                   <div class="form-group row" runat="server" visible="true" id="documentos">
                                       <div class="col-sm-12">                                                                                              
                                                                            ...
                                                                            <asp:Repeater ID="rpt_support_docs" runat="server" >
                                                                                <ItemTemplate> 
                                                                                    <tr>
                                                                                        ...
                                                                                        <td><a class="btn btn-lg btn-outline-secondary" target="_blank"  href="http://amazoniamia.org/RMS_approvals/FileUploads/ApprovalProcc/<%# Eval("archivo") %>" role="button"><i class="<%# Eval("ext_icon") %>"></i></a></td>
                                                                                        <td><a class="btn btn-sm btn-outline-secondary" target="_blank"  href=""http://amazoniamia.org/RMS_approvals/FileUploads/ApprovalProcc/<%# Eval("archivo") %>" role="button"><%# Eval("archivo") %></a></td>                                                                                                                                      
                                                                                              ...
                                                                                              <div class="direct-chat-msg <%# Eval("align1")%> "  >
                                                                                                  <div class="direct-chat-info clearfix">
                                                                                                   <i class="fa <%# Eval("fa_icon")%> fa-2x <%# Eval("align2")%> " aria-hidden="true" title="<%# Eval("icon_message")%>"></i>&nbsp;&nbsp;&nbsp; <span class="direct-chat-name  <%# Eval("align2")%> "><%# Eval("empleado")%></span>
                                                                                                    <span class="direct-chat-timestamp  <%# Eval("align3") %> "> <%# Eval("fecha_comentario") %> <i class="fa fa-clock-o"></i> <%#  Eval("fecha_comentario") %> </span>
