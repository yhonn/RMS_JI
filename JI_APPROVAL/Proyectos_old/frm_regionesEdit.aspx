<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/Site.Master" CodeBehind="frm_regionesEdit.aspx.vb" Inherits="RMS_APPROVAL.frm_regionesEdit" %>
    ...
    <section class="content">
        <div class="box">
            <div class="box-header with-border">
                <h3 class="box-title">
                    <asp:Label runat="server" ID="lblt_subtitulo_pantalla">Región - Editar</asp:Label></h3>
            </div>
            <div class="box-body">
                <div class="col-lg-12">
                    <div class="box-body">
                        <div class="form-group row">
                            <div class="col-sm-4 text-right">
                                <asp:Label ID="lbl_id_region" runat="server" Font-Bold="True" Font-Names="Arial"
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-8">
                                <telerik:RadComboBox runat="server" ID="cmb_programa" Width="500px"
