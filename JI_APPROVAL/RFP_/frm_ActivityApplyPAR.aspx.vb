...
Public Class frm_ActivityApplyPAR
    Inherits System.Web.UI.Page

    Dim cl_user As ly_SIME.CORE.cls_user
    Dim frmCODE As String = "AP_ACT_APPLY_PAR"
        ...
        If Not Me.IsPostBack Then
            ...
            Using dbEntities As New dbRMS_JIEntities
                ...
                If oTA_APPLY_SCREENING.Count > 0 Then
                    ...
                    '"~/RFP_/frm_ActivityApplyPAR?ab=" & IDActivity_Solicitation.ToString & "&ac=" & IDSolicitation_AP.ToString & "&ad=" & IDSolicitation_AP_USER_TK.ToString
                End If
                ...
                If Not IsNothing(oSolicitation) Then
                    ...
                    'dtApplicants = get_Activity_Applicants(oSolicitation.ID_ACTIVITY_SOLICITATION)
