...
Partial Public Class frm_ActivityAD2
    ...
    '''<summary>
    '''Control grd_approvals.
    '''</summary>
    '''<remarks>
    '''Campo generado automáticamente.
    '''Para modificarlo, mueva la declaración del campo del archivo del diseñador al archivo de código subyacente.
    '''</remarks>
    Protected WithEvents grd_approvals As Global.Telerik.Web.UI.RadGrid
    ...
    '''<summary>
    '''Control btn_select_approval.
    '''</summary>
    '''<remarks>
    '''Campo generado automáticamente.
    '''Para modificarlo, mueva la declaración del campo del archivo del diseñador al archivo de código subyacente.
    '''</remarks>
    Protected WithEvents btn_select_approval As Global.Telerik.Web.UI.RadButton
End Class
