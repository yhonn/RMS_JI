<%@ Page Language="vb" AutoEventWireup="false" MasterPageFile="~/Site.Master" CodeBehind="frm_ActivityAD2.aspx.vb" Inherits="RMS_APPROVAL.frm_ActivityAD2" %>
                                ...
                                <div id="collapseOne" class="panel-collapse collapse in" role="tabpanel" aria-labelledby="headingOne">
                                    ...
                                    <div class="form-group row">
                                     ...
                                     <div class="form-group row">
                                        ...
                                        <div class="col-sm-9">
                                            <telerik:RadNumericTextBox ID="txt_exchange_rate" runat="server"  NumberFormat-DecimalDigits="4" ></telerik:RadNumericTextBox>
                                        </div>
                                    </div>
