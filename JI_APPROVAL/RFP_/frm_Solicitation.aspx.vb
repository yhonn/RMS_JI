...
Public Class frm_Solicitation
    Inherits System.Web.UI.Page

    Dim cl_user As ly_SIME.CORE.cls_user
    Dim cl_error As New ly_SIME.CORE.ErrorHandler
    Dim frmCODE As String = "AP_ADMIN_SOLIC"
    ...
    Sub fillGrid(ByVal bndBind As Boolean)
        ...
        Using dbentities As New dbRMS_JIEntities
            ...
            Dim bndTypeSOL As Integer = 0
            Dim idTypeSOL As Integer = 0
            ...
            If Me.chk_allsolTYPES.Checked Then
                bndTypeSOL = 1
                idTypeSOL = 0
            Else
                bndTypeSOL = 0
                idTypeSOL = Val(Me.cmb_solicitation_type.SelectedValue)
            End If
            ...
            Me.grd_cate.DataSource = dbentities.VW_TA_ACTIVITY_SOLICITATION.Where(Function(p) (p.SOLICITATION_TITLE.Contains(Me.txt_doc.Text) Or
                                                                                                 p.SOLICITATION_PURPOSE.Contains(Me.txt_doc.Text) Or
                                                                                                 p.SOLICITATION_CODE.Contains(Me.txt_doc.Text) Or
                                                                                                 p.SOLICITATION.Contains(Me.txt_doc.Text)) And
                                                                                                 p.ID_PROGRAMA = id_programa And
                                                                                                 (p.ID_SOLICITATION_TYPE = idTypeSOL Or 1 = bndTypeSOL) And
                                                                                                 (p.id_region = idRegion Or 1 = bndRegion) And
                                                                                                 (p.id_subregion = idSubRegion Or 1 = bndSubRegion) And
                                                                                                  p.ID_PROGRAMA = id_programa).ToList()
    ...
    Protected Sub grd_cate_ItemDataBound(ByVal sender As Object, ByVal e As Telerik.Web.UI.GridItemEventArgs) Handles grd_cate.ItemDataBound
        ...
        If e.Item.ItemType = GridItemType.AlternatingItem Or e.Item.ItemType = GridItemType.Item Then
            ...
            hlnkEdit.NavigateUrl = "frm_ActivitySolicitation?Id=" & DataBinder.Eval(e.Item.DataItem, "id_activity").ToString()
    ...
    Protected Sub btn_nuevo_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles btn_nuevo.Click
        Me.Response.Redirect("~/RFP_/frm_ActivitySolicitation?Id=0")
    End Sub
    ...
    Sub LoadLista()
        ...
        Using dbEntities As New dbRMS_JIEntities
            ...
            Me.cmb_solicitation_type.DataSource = dbEntities.TA_SOLICITATION_TYPE.Where(Function(p) p.ID_PROGRAMA = idPrograma).ToList()
        ...
        Me.chk_allsolTYPES.Checked = True
    ...
    Protected Sub chk_allsolicitationTYPES(sender As Object, e As EventArgs) Handles chk_allsolTYPES.CheckedChanged
        fillGrid(True)
    End Sub
