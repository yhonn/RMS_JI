<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/Partner.Master" CodeBehind="frm_ActivityApplyPAR.aspx.vb" Inherits="RMS_APPROVAL.frm_ActivityApplyPAR" %>
                       ...
                       <div id="SolicitationRejected" runat="server"  class="form-group row" style="display:none;">
                        ...
                        <div id="stepwizard" class="border-0"> 
                             ...
                             <p id="_Documents">&nbsp;</p>
                              ...
                              <ul class="nav">
                                    <li class="nav-item">
                                        <a id="step_solic" runat="server" href="#step-1" class="nav-link" >1<br /><small> <asp:Label runat="server" ID="lblt_solicitation">Solicitation Overview</asp:Label> </small></a>
                                    </li>
                                    <li class="nav-item">
                                        <a  id="step_start_Application" runat="server" href="#step-2"   class="nav-link" >2<br /><small> <asp:Label runat="server" ID="lblt_start">Start Application</asp:Label></small></a>
                                    </li>   
                                   <li class="nav-item">
                                      <a  id="step_support_documents" runat="server" href="#step-3"   class="nav-link" >3<br /><small> <asp:Label runat="server" ID="lblt_support_documents">Support Documents</asp:Label></small></a>
                                   </li>
                                   <li class="nav-item">
                                         <a  id="step_apply" runat="server" href="#step-4"   class="nav-link" >4<br /><small> <asp:Label runat="server" ID="lblt_apply">Apply</asp:Label></small></a>
                                   </li>
                              </ul>
                            ...
                            <div class="card tab-content border-0">
                                 ...
                                 <div class="card-header">
                                     <h6 class="card-title">
                                         <asp:Label runat="server" ID="lblt_tab_label">Solicitation Overview</asp:Label>
                                     </h6>   
                                  <%-- <div class="card-tools">
                               ...
                               <div id="step-1" class="card-body tab-pane border-0"  role="tabpanel">
                                ...
                                <%--***********************************************  STEP #2 ************************************************************--%>
                                <%--*********************************************** # START APPLICATION # ************************************************************--%>
                                <div id="step-2" class="card-body tab-pane" role="tabpanel">   
                                ...
                                //console.log('Tab index order ' + TABindex);
                                 ...
                                 set_step(TABindex);     
                                  ...
                                  function set_step(IndexINI,_Reset) {
                                               ...
                                               var TABindexMAX = $("[id*=tab_index_max]").val() != "" ? $("[id*=tab_index_max]").val() : "0";
                                                ...
                                                console.log('Tab index Max ' + TABindexMAX);
                                                   ...
                                                   //     }
                                                    ...
                                                    var j = 0;
                                                    for (i = parseInt(TABindexMAX) + 1 ; i < 4; i++) {                                    
                                      ...
                                      console.log(JSON.stringify(disabledARRAY));
