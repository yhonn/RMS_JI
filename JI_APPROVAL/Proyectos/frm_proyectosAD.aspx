<%@ Page Language="vb" AutoEventWireup="false" MasterPageFile="~/Site.Master" CodeBehind="frm_proyectosAD.aspx.vb" Inherits="RMS_APPROVAL.frm_proyectosAD" %>
    ...
    <section class="content">
        <div class="box">
            <div class="box-header with-border">
                       ...
                       <div class="col-sm-6">   
                           <h3 class="box-title">
                                <asp:Label runat="server" ID="lblt_subtitulo_pantalla">Actividades - Nuevo</asp:Label>
                            </h3>                     
                        </div>
                         <div class="col-sm-3 pull-right box-tools">                    
                             <%--<telerik:RadButton ID="btn_approbals" runat="server" BackColor="#3c8dbc"  AutoPostBack="true" Text="Importar desde Approvals" CssClass="btn btn-primary btn-sm pull-right margin-r-5" CausesValidation="false" ValidationGroup="2" BorderColor="#3C8DBC" ForeColor="White">
                             </telerik:RadButton>--%>
                        ...
                        <div class="panel-group" id="accordion" role="tablist" aria-multiselectable="true">
                            <div class="panel panel-default">
                                ...
                                <div id="collapseOne" class="panel-collapse collapse in" role="tabpanel" aria-labelledby="headingOne">
                                    ...
                                    <div class="form-group row">
                                        <div class="col-sm-3 text-right">
                                            <asp:Label runat="server" ID="Label2" CssClass="control-label text-bold">Responsable del componente</asp:Label>
                                        </div>
                                        <div class="col-sm-9">
                                    ...
                                    <div class="form-group row">
                                        <div class="col-sm-3 text-right">
                                            <asp:Label runat="server" ID="lblt_persona_encargada" CssClass="control-label text-bold">Persona encargada</asp:Label>
                                        </div>
                                        <div class="col-sm-9">
                                   ...
                                   <%-- <div class="form-group row">
                                        <div class="col-sm-3 text-right">
                                            <asp:Label runat="server" ID="Label1" CssClass="control-label text-bold">Personal técnico asociado </asp:Label>
                                        </div>
                                        <div class="col-sm-9">
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-9">
                                            <telerik:RadComboBox ID="cmb_persona_encargada" Filter="Contains" runat="server" Width="500px">
                                            </telerik:RadComboBox>
                                        </div>
                                    </div>
                                    <div class="form-group row">
                                    ...
                                    <%--<div class="form-group row">
                                        <div class="col-sm-3 text-right">
                                            <asp:Label runat="server" ID="Label3" CssClass="control-label text-bold">Área de intervensión</asp:Label>
                                        </div>
                                        <div class="col-sm-8">
                                    ...
                                    <div class="form-group row hidden">
                                        ...
                                        <div class="col-sm-2">
                                            <telerik:RadButton ID="btn_add_personal" runat="server" Text="Agregar" AutoPostBack="true" CssClass="btn btn-sm pull-right margin-r-5" Enabled="false"
                                    ...
                                    <div class="form-group row hidden">
                                        <div class="col-lg-12">
                                            <telerik:RadGrid ID="grd_personal_tecnico" runat="server" AutoGenerateColumns="false" DataSourceID="sqlDTS_personal_tecnico" 
                                                Width="500px" Enabled="false">
                                                <%--OnItemCommand="grd_partners_ItemCommand" --%>
                                                <%--OnNeedDataSource="grd_partners_NeedDataSource"--%>
                                                <PagerStyle AlwaysVisible="true" />
                                                <MasterTableView DataKeyNames="id_personal_tecnico" CommandItemDisplay="Top" CommandItemSettings-ShowRefreshButton="false" DataSourceID="sqlDTS_personal_tecnico">
                                                    <Columns>
                                                        <telerik:GridTemplateColumn UniqueName="colm_Eliminar">
                                                            <HeaderStyle Width="10" />
                                                            <ItemTemplate>
                                                        ...
                                                        <telerik:GridBoundColumn DataField="id_personal_tecnico" UniqueName="id_personal_tecnico" HeaderText="id_personal_tecnico" Visible="false">
                                                        </telerik:GridBoundColumn>
                                                        <telerik:GridBoundColumn DataField="personal_tecnico" FilterControlAltText="Filter personal_tecnico column"
                                                            HeaderText="Nombre" SortExpression="personal_tecnico" UniqueName="personal_tecnico" Visible="true">
                                                        </telerik:GridBoundColumn>
                                                    </Columns>
                                                </MasterTableView>
                                            </telerik:RadGrid>
            ...
            <div class="vertical-alignment-helper">
                <div class="modal-dialog modal-sm vertical-align-center">
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                            <asp:Label ID="lblt_msn_tasa_cambio" runat="server" Text="Debe ingresar la tasa de cambio" />
                        </div>
                        <div class="modal-footer">
