...
Public Class frm_proyectosAD
    ...
    Dim frmCODE As String = "AP_NEW_PROY"
    ...
    Sub loadListas(ByVal idPrograma As Integer)
        Using dbEntities As New dbRMS_JIEntities
            ...
            '                 Where q.id_programa = idPrograma And u.asociado_componente = True
            ...
            'Me.cmb_personal_tecnico.DataSource = entryPoint.Where(Function(p) p.busqueda_actividad = True).OrderBy(Function(p) p.nombre).ToList()
            ...
            Me.cmb_persona_encargada.DataSourceID = ""
            Me.cmb_persona_encargada.DataSource = entryPoint.OrderBy(Function(p) p.nombre).ToList()
            Me.cmb_persona_encargada.DataTextField = "nombre"
            Me.cmb_persona_encargada.DataValueField = "id_usuario"
            Me.cmb_persona_encargada.DataBind()
            ...
            'Me.cmb_area_intervension.DataValueField = "id_area_intervension"
    ...
    Sub LoadPErsonalTecnico()
        Me.sqlDTS_personal_tecnico.SelectCommand = "select CONCAT(b.nombre_usuario, b.apellidos_usuario) personal_tecnico, a.id_personal_tecnico from tme_ficha_proyecto_personal_tecnico a inner join t_usuarios b on a.id_usuario = b.id_usuario where id_session = '" & Me.lbl_id_sesion_temp.Text & "'"
        Me.grd_personal_tecnico.DataBind()
    End Sub
    Sub LoadData()
    ...
    '        personalTecnico.id_session = Me.lbl_id_sesion_temp.Text
    ...
    Protected Sub btn_guardar_Click(sender As Object, e As EventArgs) Handles btn_guardar.Click
        ...
        Using dbEntities As New dbRMS_JIEntities
            ...
            If Not bndError Then
                ...
                If Me.cmb_persona_encargada.SelectedValue IsNot Nothing Then
                    Dim idPersonaEncargada = Convert.ToInt32(Me.cmb_persona_encargada.SelectedValue)
                    Dim oUsuaAct = dbEntities.t_usuario_ficha_proyecto.Where(Function(p) p.id_usuario = idPersonaEncargada And p.id_ficha_proyecto = idFicha).FirstOrDefault()
                ...
                'If Me.cmb_responsable_componente.SelectedValue IsNot Nothing Then
                '    Dim id_responsableComponente = Convert.ToInt32(Me.cmb_responsable_componente.SelectedValue)
                '    Dim oUsuaAct = dbEntities.t_usuario_ficha_proyecto.Where(Function(p) p.id_usuario = id_responsableComponente And p.id_ficha_proyecto = idFicha).FirstOrDefault()
                '    If oUsuaAct Is Nothing Then
                '        oUsuaAct = New t_usuario_ficha_proyecto
                '        oUsuaAct.id_usuario = Me.cmb_persona_encargada.SelectedValue
                '        oUsuaAct.id_ficha_proyecto = idFicha
                ...
                '    Dim oUsuaAct = dbEntities.t_usuario_ficha_proyecto.Where(Function(p) p.id_usuario = idPersonalTecnico And p.id_ficha_proyecto = idFicha).FirstOrDefault()
                '    If oUsuaAct Is Nothing Then
                '        oUsuaAct = New t_usuario_ficha_proyecto
                ...
                dbEntities.SaveChanges()
                'dbEntities.Database.ExecuteSqlCommand("update tme_ficha_proyecto_personal_tecnico set id_ficha_proyecto = " & oFicha.id_ficha_proyecto & " where id_session = '" & Me.lbl_id_sesion_temp.Text & "'")
    ...
    Protected Sub cmb_periodo_SelectedIndexChanged(sender As Object, e As RadComboBoxSelectedIndexChangedEventArgs)
