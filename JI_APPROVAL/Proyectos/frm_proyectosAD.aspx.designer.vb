...
Partial Public Class frm_proyectosAD
    ...
    '''<summary>
    '''cmb_personal_tecnico control.
    '''</summary>
    '''<remarks>
    '''Auto-generated field.
    '''To modify move field declaration from designer file to code-behind file.
    '''</remarks>
    Protected WithEvents cmb_personal_tecnico As Global.Telerik.Web.UI.RadComboBox

    '''<summary>
    '''btn_add_personal control.
    '''</summary>
    '''<remarks>
    '''Auto-generated field.
    '''To modify move field declaration from designer file to code-behind file.
    '''</remarks>
    Protected WithEvents btn_add_personal As Global.Telerik.Web.UI.RadButton

    '''<summary>
    '''grd_personal_tecnico control.
    '''</summary>
    '''<remarks>
    '''Auto-generated field.
    '''To modify move field declaration from designer file to code-behind file.
    '''</remarks>
    Protected WithEvents grd_personal_tecnico As Global.Telerik.Web.UI.RadGrid

    '''<summary>
    '''sqlDTS_personal_tecnico control.
    '''</summary>
    '''<remarks>
    '''Auto-generated field.
    '''To modify move field declaration from designer file to code-behind file.
    '''</remarks>
    Protected WithEvents sqlDTS_personal_tecnico As Global.System.Web.UI.WebControls.SqlDataSource
