<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/Site.Master" CodeBehind="frm_subregionesAD.aspx.vb" Inherits="RMS_APPROVAL.frm_subregionesAD" %>
                ...
                <div class="col-lg-12">
                    <div class="box-body">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-8">
                                <telerik:RadComboBox runat="server" ID="cmb_programa" Width="500px" AutoPostBack="true" Enabled="false">
                                </telerik:RadComboBox>
                            </div>
                        </div>
                        <div class="form-group row">
