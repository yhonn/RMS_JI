<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/Site.master" Inherits="RMS_APPROVAL.frm_EjecutorAD" CodeBehind="frm_EjecutorAD.aspx.vb" %>
    ...
    <section class="content">
        <div class="box">
            <div class="box-header with-border">
                <h3 class="box-title">
                    <asp:Label runat="server" ID="lblt_subtitulo_pantalla">Ejecutores - Nuevo</asp:Label></h3>
            </div>
            <div class="box-body">
                <div class="col-lg-12">
                    <div class="box-body">
                        <div class="form-group row">
                            <div class="col-sm-2">
                                <asp:Label runat="server" ID="lblt_codigo" CssClass="control-label text-bold hidden">Código Ejecutor</asp:Label>
                        ...
                        <div class="form-group row">
                            <div class="col-sm-2">
                                <asp:Label runat="server" ID="lblt_representante" CssClass="control-label text-bold">Persona de contacto</asp:Label>
                            </div>
                            <div class="col-sm-4">
                            ...
                            <div class="col-sm-2">
                                <asp:Label runat="server" ID="lblt_cedula" CssClass="control-label text-bold">Cédula de contacto</asp:Label>
                            </div>
                            <div class="col-sm-4">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-2">
                                <asp:Label runat="server" ID="lblt_telefono_rep" CssClass="control-label text-bold">Teléfono de contacto</asp:Label>
                            </div>
                            <div class="col-sm-4">
                            ...
                            <div class="col-sm-2">
                                ...
                                <asp:Label runat="server" ID="lblt_direccion" CssClass="control-label text-bold">Dirección de contacto</asp:Label>
                            </div>
                            <div class="col-sm-4">
