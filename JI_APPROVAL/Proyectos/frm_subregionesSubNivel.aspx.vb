...
Public Class frm_subregionesSubNivel
        ...
        If Not IsPostBack Then
            ...
            If cl_user.codigo_nivel_usuario = "SYS_ADMIN" Or cl_user.codigo_nivel_usuario = "SYS_P_ADM" Then
                ...
                If cl_user.codigo_nivel_usuario = "SYS_P_ADM" Then
                    ...
                    Me.cmb_programa.DataSource = clListado.get_t_programas_usuario(cl_user.id_usr)
    ...
    Sub LoadData()
        ...
        Me.cmb_programa.DataSource = clListado.get_t_programas(idP)
        ...
        Using dbEntities As New dbRMS_JIEntities
            ...
            Dim sql = "SELECT " & nivel.campo_nombre_tabla & ", " & nivel.campo_id_tabla & " FROM " & nivel.nombre_tabla & " WHERE " _
                      & nivel.campo_id_tabla & " NOT IN (SELECT id_relacion FROM tme_subregion_nivel_avance WHERE id_subregion = " & Me.lbl_id_subregion.Text & ")  AND id_programa = " & idP & " ORDER BY " & nivel.campo_nombre_tabla
