                    ...
                    <MasterTableView AutoGenerateColumns="False" DataKeyNames="id_subregion" AllowAutomaticUpdates="True">
                        <Columns>
                            ...
                            <telerik:GridTemplateColumn FilterControlAltText="filtro comments column" UniqueName="Edit" Visible="false">
                                <ItemTemplate>
                                    <asp:HyperLink ID="col_hlk_edit" runat="server" ImageUrl="../Imagenes/iconos/b_edit.png" ToolTip="Editar subregiones" Target="_self" />
                                </ItemTemplate>
                                <ItemStyle Width="5px" />
                            </telerik:GridTemplateColumn>
                            ...
                            <telerik:GridTemplateColumn FilterControlAltText="Filter visible column"
                                ...
                                <ItemTemplate>
                                    <asp:HyperLink ID="col_hlk_subNivel" runat="server" ImageUrl="../Imagenes/iconos/additem.png" ToolTip="Agregar SubNivel - Departamentos" Target="_self" />
                                </ItemTemplate>
                                <ItemStyle Width="5px" />
                            </telerik:GridTemplateColumn>
                        </Columns>
