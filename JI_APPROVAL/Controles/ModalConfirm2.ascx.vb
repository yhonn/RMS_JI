Public Class ModalConfirm2
    ...
    Public CssOption As String
    Public Property SuccessOption() As String
        Get
            Return CssOption
        End Get
        Set(ByVal value As String)
    ...
    Public Sub Set_Success(ByVal optSucc As Boolean)
        If optSucc Then
            Me.CssOption = " modal-success "
        Else
            Me.CssOption = " modal-danger "
        End If
    End Sub
