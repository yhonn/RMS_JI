...
Public Class frm_employee_profile
    ...
    Dim frmCODE As String = "PROF_EMPLOYEE"
    ...
    Protected Sub btn_salir_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles btn_salir.Click
        Me.MsgReturn.Redireccion = "~/HRM/frm_employees"
    ...
    Sub FillData(ByVal idUsuario As String)
        ...
        Using dbEntities As New dbRMS_JIEntities
            ...
            Me.cmb_gender.DataSource = dbEntities.tme_sex_type.Where(Function(p) p.id_programa = id_programa).ToList()
            ...
            If id_employee = 0 Then
                ...
                Me.txt_documento.Text = oUsuario.numero_documento
        ...
        If Not IsNothing(ds.Tables(0)) Then
            ...
            For j = 0 To ds.Tables(0).Columns.Count - 1
                ...
                ElseIf j = 7 Then
                    ...
                    str_tbl_HEADER &= String.Format("<th>{0}</th>", "EMPLOYMENT DAYS") ' ds.Tables(0).Columns(j).ColumnName.ToString
                    cols += 1

                ElseIf j = 8 Then

                    'str_tbl_HEADER &= String.Format("<th>{0}</th>", ds.Tables(0).Columns(j).ColumnName.ToString.ToUpper)
                    str_tbl_HEADER &= String.Format("<th>{0}</th>", "AL_ACCRUED")
                    cols += 1
    ...
    Public Function annual_leave_table(ByVal idUser As Integer) As String
        ...
        Dim cssDATA_BG As String = "color: #000;background-color: #d2d6de;"
        ...
        Dim cssBoldFont As String = "font-weight:700;font-family: Arial, Helvetica, sans-serif;font-size: small;"
        ...
        If Not IsNothing(ds.Tables(0)) And ds.Tables(0).Rows.Count() > 0 Then
            ...
            strTableHeader_line2 &= String.Format("<th style='{0}'>EMPLOYMENTS DAYS</th>", cssBoldFont)
            ...
            For Each dtRow In ds.Tables(0).Rows
                ...
                If dtRow("worked_days") > 0 Then
                    ...
                    For k = 9 To ds.Tables(0).Columns.Count - 3
                        ...
                        strTableRows &= String.Format(strCellBody, If(dtRow(ds.Tables(0).Columns(k).ColumnName.ToString) > 0, cssBoldFont, ""), cssText_Left, If(dtRow(ds.Tables(0).Columns(k).ColumnName.ToString) > 0, cssDATA_BG, ""), dtRow(ds.Tables(0).Columns(k).ColumnName.ToString))
    ...
    Public Function casual_leave_table(ByVal idUser As Integer) As String
        ...
        Dim strTableHeader_line1 As String = ""
        Dim strTableHeader_line2 As String = ""
        Dim strTableHeader_line3 As String = ""

        Dim strCellHeader As String = "<th style='{1}' {2}>{0}</th>"
        Dim strTableBody As String = ""
        Dim strTableRows As String = ""
        Dim strCellBody As String = " <td {0} style='{1}{2}'>{3}</td> "
        Dim cssDATA_BG As String = "color: #000;background-color: #d2d6de;"
        ...
        If Not IsNothing(ds.Tables(0)) And ds.Tables(0).Rows.Count() > 0 Then
            ...
            strTableHeader_line2 &= String.Format("<th colspan='2' rowspan='2' style='{0}' >YEAR</th>", cssBoldFont)
            strTableHeader_line2 &= String.Format("<th  rowspan='2' style='{0}'>EMPLOYMENTS DAYS</th>", cssBoldFont)
            strTableHeader_line2 &= String.Format("<th  rowspan='2' style='{0}'>CASUAL LEAVE ACCRUED</th>", cssBoldFont)
            strTableHeader_line2 &= String.Format("<th  rowspan='2' style='{0}'>SICK LEAVE ACCRUED</th>", cssBoldFont)

            cols = 5
            Dim arrMONTHS() As String = {"Jan", "Feb", "Mar", "Apr", "May", "Jun", "Jul", "Aug", "Sep", "Oct", "Nov", "Dec"}
            Dim arrCAT() As String = {"CL", "SL"}

            'Dim strMonth As String = "NN"
            strTableHeader_line3 = String.Format("<tr style ='color: #fff;background-color: #00796B;'>")


            For j = 0 To 11

                strTableHeader_line2 &= String.Format(strCellHeader, "&nbsp;&nbsp;" & arrMONTHS(j) & "&nbsp;&nbsp;", cssBoldFont & cssText_Center, " colspan='2' ")

                For i = 0 To 1

                    strTableHeader_line3 &= String.Format(strCellHeader, "&nbsp;&nbsp;" & arrCAT(i) & "&nbsp;&nbsp;", cssBoldFont & cssText_Center, " ")
                    cols += 1
            ...
            strTableHeader_line2 &= String.Format("<th  rowspan='2' style='{0}'>CASUAL DAYS TAKEN</th>", cssBoldFont)
            strTableHeader_line2 &= String.Format("<th  rowspan='2' style='{0}'>CASUAL DAYS BALANCE</th>", cssBoldFont)
            strTableHeader_line2 &= String.Format(strCellHeader, "", "", "rowspan='2'")
            strTableHeader_line2 &= String.Format("<th  rowspan='2' style='{0}'>SICK DAYS TAKEN</th>", cssBoldFont)
            strTableHeader_line2 &= String.Format("<th  rowspan='2' style='{0}'>SICK DAYS BALANCE</th>", cssBoldFont)
            strTableHeader_line2 &= String.Format(strCellHeader, "", "", "rowspan='2'")

            cols += 6

            strTableHeader_line2 &= "</tr>"
            strTableHeader_line3 &= "</tr>"

            strTableHeader_line1 = String.Format("<tr style ='color: #fff;background-color: #00796B;'>")
            strTableHeader_line1 &= String.Format("<th colspan='{0}' style='{1}'>CASUAL/SICK LEAVE: {2}{4}{4}{4}{4}{4}{4}{4}{4}EMPLOYMENT DATE: {3:MM/dd/yyyy}</th>", (cols + 2).ToString, cssBoldFont & cssText_Center, String.Format("{0} {1}", ds.Tables(0).Rows.Item(0).Item("nombre_usuario"), ds.Tables(0).Rows.Item(0).Item("apellidos_usuario")), ds.Tables(0).Rows.Item(0).Item("contract_date"), "&nbsp;")
            strTableHeader_line1 &= String.Format("</tr>")


            strTableHeader &= strTableHeader_line1 & strTableHeader_line2 & strTableHeader_line3
            strTableHeader &= String.Format("</thead>")
            ...
            Dim strMonth As String = "NN"
            Dim strMonthPIV As String = "NN"

            For Each dtRow In ds.Tables(0).Rows

                If dtRow("worked_days") > 0 Then

                    strTableRows &= String.Format("<tr>" & strTHCellBody, "colspan='2' rowspan='3'", "border:1px solid lightgray;", "", dtRow("anio")) 'Open Row
                    strTableRows &= String.Format(strCellBody, "", cssText_Left, "", dtRow("worked_days"))
                    TotWorked = dtRow("worked_days")
                    ...
                    strTableRows &= String.Format(strCellBody, "", cssText_Left, "", dtRow("SICK_YEARLY"))
                    SickYearly = dtRow("SICK_YEARLY")


                    Dim Ncat As Integer = 0

                    For k = 10 To ds.Tables(0).Columns.Count - 5
                    ...
                    strTableRows &= String.Format(strTHCellBody, "", "", "", dtRow("SICK_TOT"))
                    TotSICK = dtRow("SICK_TOT")
                    strTableRows &= String.Format(strTHCellBody, "", "", "", dtRow("SICK_PEND"))
                    TotsickPEND = dtRow("SICK_PEND")
                    ...
                    strTableRows &= String.Format(strCellBody, "", "", "", String.Format("<span style='{0}'> {1}% </span>", BadgeStyle & get_Tag_HTML(1, percentSICK), percentSICK.ToString))
                    strTableRows &= "</tr>"


                    Dim strBar As String = " <tr>
                                                <td style ='color: #fff; background-color: #00796B; font-weight: 500;font-family: Arial, Helvetica, sans-serif;font-size: small; '>{3}</td>
                                                <td colspan='{0}' style='-webkit-text-size-adjust: 100%; -ms-text-size-adjust: 100%; mso-table-lspace: 0pt; mso-table-rspace: 0pt;'>
                                                    <div style='height: 20px; margin-bottom: 20px; overflow: hidden; background-color: #f5f5f5; -webkit-box-shadow: none; box-shadow: none; border-radius: 1px; margin-top: 5px; margin: 0;'>
                                                        <div style='float: left; height: 100%; font-size: 12px; line-height: 20px; color: #fff; text-align: center; -webkit-transition: width .6s ease; -o-transition: width .6s ease; transition: width .6s ease; background-color: {1}; -webkit-box-shadow: none; box-shadow: none; border-radius: 1px; width: {2}%;'>
                                                            <span>{2}%</span>
                    ...
                    strTableRows &= String.Format(strBar, (cols - 1).ToString, get_alert_ind(percentVAC), percentVAC.ToString, "CL %")

                    strTableRows &= String.Format(strBar, (cols - 1).ToString, get_alert_ind(percentSICK), percentSICK.ToString, "SL %")
            ...
            strTableFooter &= String.Format(strCellFooter, "border-top:1px solid lightgray;", If(TotWorked > 0, TotWorked.ToString, ""), cssText_Left, "")
            strTableFooter &= String.Format(strCellFooter, "border-top:1px solid lightgray;", If(TotYearly > 0, TotYearly.ToString, ""), cssText_Left, "")
            strTableFooter &= String.Format(strCellFooter, "border-top:1px solid lightgray;", If(SickYearly > 0, SickYearly.ToString, ""), cssText_Left, "")


            strTableFooter &= String.Format(strCellFooter, "", "", cssText_Center, "colspan='" & (cols - 11).ToString & "'")
            ...
            strTableFooter &= String.Format(strCellFooter, "border-top:1px solid lightgray;", TotSICK.ToString, cssText_Left, "")
            strTableFooter &= String.Format(strCellFooter, "border-top:1px solid lightgray;", TotsickPEND.ToString, cssText_Left, "")


            Dim percentSICK_TOT As Decimal = 0
            If SickYearly = 0 Then
                percentSICK_TOT = 100
            Else
                percentSICK_TOT = (1 - Math.Round((TotsickPEND / SickYearly), 2)) * 100
            End If

            strTableFooter &= String.Format(strCellFooter, "border-top:1px solid lightgray;", String.Format("<span style='{0}'> {1}% </span>", BadgeStyle & get_Tag_HTML(1, percentSICK_TOT), percentSICK_TOT.ToString), cssText_Center, "")
        ...
        If Not IsNothing(ds.Tables(0)) Then
            ...
            For j = 0 To ds.Tables(0).Columns.Count - 1
                ...
                ElseIf j = 8 Then
                    ...
                    'str_tbl_HEADER &= String.Format("<th>{0}</th>", ds.Tables(0).Columns(j).ColumnName.ToString.ToUpper)
                    str_tbl_HEADER &= String.Format("<th>{0}</th>", "CL_ACCRUDE")
                    cols += 1

                ElseIf j = 9 Then

                    'str_tbl_HEADER &= String.Format("<th>{0}</th>", ds.Tables(0).Columns(j).ColumnName.ToString.ToUpper)
                    str_tbl_HEADER &= String.Format("<th>{0}</th>", "SL_ACCRUED")
                    cols += 1
    ...
    Public Sub fill_Grid(ByVal booREbind As Boolean, ByVal idUser As Integer)
        ...
        cmd2.Parameters.AddWithValue("@_programa", Convert.ToInt32(Me.Session("E_IDPrograma")))
        ' cmd2.Parameters.AddWithValue("@_programa", Convert.ToInt32(Me.Session("E_IDPrograma")))
    ...
    Private Sub radgrid_time_reported_NeedDataSource(sender As Object, e As PivotGridNeedDataSourceEventArgs) Handles radgrid_time_reported.NeedDataSource
        ...
        Dim id_usuario As Integer = Convert.ToInt32(Me.lbl_id_usuario.Text)

        Dim cmd2 As System.Data.SqlClient.SqlCommand = New System.Data.SqlClient.SqlCommand("SP_HR_BILLABLE_TIME", cnn)
        cmd2.CommandType = CommandType.StoredProcedure
        cmd2.Parameters.AddWithValue("@tp_view", 7)
        cmd2.Parameters.AddWithValue("@_id_usuario", id_usuario)
        cmd2.Parameters.AddWithValue("@_anio", 0)
        cmd2.Parameters.AddWithValue("@_programa", Convert.ToInt32(Me.Session("E_IDPrograma")))
    ...
    Private Sub btn_test_Click(sender As Object, e As EventArgs) Handles btn_test.Click
        ...
        'Dim strTaBLE As String = annual_leave_table(2100)
        Dim strTaBLE As String = casual_leave_table(2100)
        strTaBLE = annual_leave_table(2100)
