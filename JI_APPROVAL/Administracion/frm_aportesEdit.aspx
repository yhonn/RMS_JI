<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/Site.Master" CodeBehind="frm_aportesEdit.aspx.vb" Inherits="RMS_APPROVAL.frm_aportesEdit" %>
<asp:Content ID="Content1" ContentPlaceHolderID="HeadContent" runat="server">
</asp:Content><%@ Register Assembly="AjaxControlToolkit" Namespace="AjaxControlToolkit" TagPrefix="cc1" %>
...
<asp:Content runat="server" ID="MainContent" ContentPlaceHolderID="MainContent">
    ...
    <section class="content-header">
        <h1>
            <asp:Label runat="server" ID="lblt_titulo_pantalla">Administration</asp:Label></h1>
    </section>
    <section class="content">
        <div class="box">
            <div class="box-header with-border">
                <h3 class="box-title">
                    <asp:Label runat="server" ID="lblt_subtitulo_pantalla">Funding - Edit</asp:Label></h3>
            </div>
            <div class="box-body">
                <div class="col-lg-5">
                    <div class="box-body">
                        <div class="form-group row">
                            <asp:Label ID="lbl_id_aporte" runat="server" Font-Bold="True" Font-Names="Arial"
                                    Font-Size="X-Small" ForeColor="#C00000"
                                    Visible="False"></asp:Label>
                            <div class="col-sm-4 text-right">
                                <asp:Label runat="server" ID="lblt_aporte_origen" CssClass="control-label text-bold">Source of Funding</asp:Label>
                            </div>
                            <div class="col-sm-8">
                        ...
                        <div class="form-group row">
                            <div class="col-sm-4 text-right">
                                <asp:Label runat="server" ID="lblt_aporte_cl" CssClass="control-label text-bold">Funding Type</asp:Label>
                            </div>
                            <div class="col-sm-8">
                        ...
                        <div class="form-group row">
                            <div class="col-sm-4 text-right">
                                <asp:Label runat="server" ID="lblt_rol" CssClass="control-label text-bold">Name of Funding</asp:Label>
                            </div>
                            <div class="col-sm-8">
                    ...
                    <div class="box-footer">
                        ...
                        <telerik:RadButton ID="btn_guardar" runat="server" Text="Save Funding" AutoPostBack="true" CssClass="btn btn-sm pull-right margin-r-5" Enabled="false"
