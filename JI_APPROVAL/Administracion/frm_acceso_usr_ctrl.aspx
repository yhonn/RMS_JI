<%@ Page Language="vb" AutoEventWireup="false" MasterPageFile="~/Site.Master" CodeBehind="frm_acceso_usr_ctrl.aspx.vb" Inherits="RMS_APPROVAL.frm_acceso_usr_ctrl" %>
        ...
        <div class="box">
            ...
            <div class="box-body">
                <div class="form-group row">
                    ...
                    <div class="col-sm-10">
                        ...
                        <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:dbCI_SAPConnectionString %>"
                            SelectCommand="SELECT * FROM t_control WHERE id_control NOT IN (SELECT id_control FROM t_access_usuario_ctrl WHERE id_usuario = @id_usuario) and id_mod = @id_mod and requiere_acceso = 1">
                            <SelectParameters>
                                <asp:QueryStringParameter Name="id_mod" QueryStringField="Id" />
                                <asp:QueryStringParameter Name="id_usuario" QueryStringField="IdUsuario" />
                            </SelectParameters>
                        </asp:SqlDataSource>
                        <telerik:RadButton ID="btn_nuevo" runat="server" AutoPostBack="true" Text="Asignar Acceso Control" ValidationGroup="1" Enabled="false">
                        </telerik:RadButton>
                ...
                <telerik:RadGrid ID="grd_cate" runat="server" AllowAutomaticDeletes="True" CellSpacing="0"
                    ...
                    <MasterTableView AutoGenerateColumns="False" DataKeyNames="id_acc_usuario_ctrl" AllowAutomaticUpdates="True">
                        <Columns>

                            <telerik:GridBoundColumn DataField="id_acc_usuario_ctrl"
                                FilterControlAltText="Filter id_acc_usuario_ctrl column"
                                SortExpression="id_acc_usuario_ctrl" UniqueName="id_acc_usuario_ctrl"
