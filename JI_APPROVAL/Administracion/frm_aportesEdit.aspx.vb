Imports ly_SIME
Public Class frm_aportesEdit
    Inherits System.Web.UI.Page
    Dim cl_user As ly_SIME.CORE.cls_user
    Dim frmCODE As String = "EDIT_APORTE"
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        If Not Me.IsPostBack Then
            Using dbEntities As New dbRMS_JIEntities
                ...
                Dim id_aporte = Convert.ToInt32(Me.Request.QueryString("Id").ToString)
                Dim oAporte = dbEntities.tme_Aportes.Find(id_aporte)
                Me.lbl_id_aporte.Text = id_aporte
                ...
                Me.cmb_aporte_origen.SelectedValue = oAporte.id_AporteOrigen
                ...
                Me.cmb_aporte_cl.SelectedValue = oAporte.id_AporteCL
                ...
                Me.cmb_Budget.SelectedValue = oAporte.id_budget 'Set DO Not Apply, default value

                If oAporte.id_budget = 7 Then
                    Me.cmb_Budget.Enabled = False
                    Me.SEL_BUD.Checked = False
                Else
                    Me.cmb_Budget.Enabled = True
                    Me.SEL_BUD.Checked = True
                End If


                Me.txt_nombreaporte.Text = oAporte.nombre_aporte
            End Using
        End If
    End Sub
    ...
    Protected Sub btn_guardar_Click(ByVal sender As Object, ByVal e As EventArgs) Handles btn_guardar.Click
        ...
        If errSave = False Then
            ...
            Using dbEntities As New dbRMS_JIEntities
                Dim id_aporte = Convert.ToInt32(Me.lbl_id_aporte.Text)
                Dim oAporte = dbEntities.tme_Aportes.Find(id_aporte)
                ...
                dbEntities.Entry(oAporte).State = Entity.EntityState.Modified
