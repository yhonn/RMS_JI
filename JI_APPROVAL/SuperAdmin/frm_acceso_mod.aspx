<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/Site.Master" CodeBehind="frm_acceso_mod.aspx.vb" Inherits="RMS_APPROVAL.frm_acceso_mod" %>
        ...
        <div class="box">
            ...
            <div class="box-body">
                    ...
                    <div class="col-sm-10">
                        ...
                        <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:dbCI_SAPConnectionString %>"
                            SelectCommand="Select a.id_mod, a.mod_name as mod_name  
                                             FROM t_mod a
                                              INNER JOIN dbo.t_sys d ON a.id_sys = d.id_sys WHERE a.superadmin = 0 and a.id_sys = @id_sys and a.id_mod NOT IN (SELECT id_mod from VW_GR_USER_MOD where id_rol = @id_rol)">
                            <SelectParameters>
                                <asp:QueryStringParameter Name="id_rol" QueryStringField="Id" />
                                <asp:ControlParameter Name="id_sys" ControlID="cmb_sistema" />
                            </SelectParameters>
                        </asp:SqlDataSource>
                        <telerik:RadButton ID="btn_nuevo" runat="server" AutoPostBack="true" Text="Asignar Acceso a Módulo" ValidationGroup="1">
                        </telerik:RadButton>
                ...
                <telerik:RadGrid ID="grd_cate" runat="server" AllowAutomaticDeletes="True" CellSpacing="0"
                    ...
                    <MasterTableView AutoGenerateColumns="False" DataKeyNames="id_acc_mod" AllowAutomaticUpdates="True">
                        <Columns>
                            <telerik:GridBoundColumn DataField="id_acc_mod"
                                FilterControlAltText="Filter id_acc_mod column"
                                SortExpression="id_acc_mod" UniqueName="id_acc_mod"
                                Visible="False" DataType="System.Int32" HeaderText="id_acc_mod"
                                ReadOnly="True">
