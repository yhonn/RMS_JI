...
Public Class frm_programas
    Inherits System.Web.UI.Page
    Dim cl_user As ly_SIME.CORE.cls_user
    Dim cl_error As New ly_SIME.CORE.ErrorHandler
    Dim frmCODE As String = "AP_ADMIN_PROG"
    ...
    Sub fillGrid()
        ...
        Me.grd_cate.DataSource = db.t_programas.Where(Function(p) p.nombre_programa.Contains(Me.txt_doc.Text)).ToList()
    ...
    Protected Sub grd_cate_ItemDataBound(ByVal sender As Object, ByVal e As Telerik.Web.UI.GridItemEventArgs) Handles grd_cate.ItemDataBound
        If e.Item.ItemType = GridItemType.AlternatingItem Or e.Item.ItemType = GridItemType.Item Then
            ...
            hlnkEdit.NavigateUrl = "frm_programasEdit?Id=" & DataBinder.Eval(e.Item.DataItem, "id_programa").ToString()
            ...
            hlnkDelete.Attributes.Add("data-href", DataBinder.Eval(e.Item.DataItem, "id_programa").ToString())
            hlnkDelete.Attributes.Add("data-identity", DataBinder.Eval(e.Item.DataItem, "id_programa").ToString())
            hlnkDelete.ToolTip = controles.iconosGrid("col_hlk_eliminar")

            Dim hlnkIdioma As HyperLink = New HyperLink
            hlnkIdioma = CType(e.Item.FindControl("col_hlk_idioma"), HyperLink)
            hlnkIdioma.NavigateUrl = "frm_programasIdioma?Id=" & DataBinder.Eval(e.Item.DataItem, "id_programa").ToString()
            hlnkIdioma.ToolTip = controles.iconosGrid("col_hlk_idioma")
    ...
    Protected Sub btn_nuevo_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles btn_nuevo.Click
        Me.Response.Redirect("~/SuperAdmin/frm_programasAD")
    End Sub
    ...
    Protected Sub esp_ctrl_btn_eliminar_Click(sender As Object, e As EventArgs) Handles esp_ctrl_btn_eliminar.Click
        Using db As New ly_SIME.dbRMS_JIEntities
            Try
                db.Database.ExecuteSqlCommand("DELETE FROM t_programas WHERE id_programa = " + Me.identity.Text)
