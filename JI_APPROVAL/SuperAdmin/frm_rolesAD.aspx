<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/Site.Master" CodeBehind="frm_rolesAD.aspx.vb" Inherits="RMS_APPROVAL.frm_rolesAD" %>
    ...
    <section class="content">
        <div class="box">
            <div class="box-header with-border">
                <h3 class="box-title">
                    <asp:Label runat="server" ID="lblt_subtitulo_pantalla">Rol - Nuevo</asp:Label></h3>
            </div>
            <div class="box-body">
                <div class="col-lg-5">
                    <div class="box-body">
