        ...
        Try
            ...
            If Not IsPostBack Then
                Using dbEntities As New dbRMS_JIEntities
                    ...
                    Dim Tbl_Programa_setting As DataTable = cl_utl.setObjeto("t_programa_settings", "id_programa", id_programa).Copy
                    Dim strProgramIMG As String = If(Not String.IsNullOrEmpty(Tbl_Programa_setting.Rows.Item(0).Item("img_client")), Tbl_Programa_setting.Rows.Item(0).Item("img_client"), "'/images/activities/accent.png")
                    ...
                    imgProgram.ImageUrl = ResolveUrl(strProgramIMG)
                    'Else
                    '    imgProgram.ImageUrl =
                    'End If
