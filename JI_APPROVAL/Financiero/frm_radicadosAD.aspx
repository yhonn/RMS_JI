<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/Site.Master" CodeBehind="frm_radicadosAD.aspx.vb" Inherits="RMS_APPROVAL.frm_radicadosAD" %>
    ...
    <section class="content">
        <div class="box">
            <div class="box-header with-border">
                <h3 class="box-title">
                    <asp:Label runat="server" ID="lblt_subtitulo_pantalla">Registrar radicación</asp:Label></h3>
                ...
                <div class="col-lg-12">
                    <div class="box-body">
                       ...
                       <div class="form-group row" >
                           ...
                           <div class="col-sm-4">
                                <asp:Label runat="server" ID="Label4" CssClass="control-label text-bold">Tipo de documento</asp:Label>
                                <br />
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-4">
                                ...
                                <br />
                                <telerik:RadNumericTextBox ID="txt_identificacion_tercero_a_pagar_" NumberFormat-DecimalDigits="0" runat="server"  Width="90%" MaxLength="1000">
                                </telerik:RadNumericTextBox>
                            ...
                            <div class="col-sm-4">
                                ...
                                <br />
                                <telerik:RadTextBox CssClass="upper" ID="txt_tercero_a_pagar" runat="server"  Width="90%" MaxLength="1000">
                                </telerik:RadTextBox>
                        ...
                        <div class="form-group row">
                            <div class="col-sm-4">
                                ...
                                <br />
                                <telerik:RadTextBox CssClass="upper" ID="txt_documento" runat="server" Rows="3" TextMode="MultiLine" Width="90%" MaxLength="1000">
                                </telerik:RadTextBox>
                            ...
                            <div class="col-sm-4">
                                ...
                                <br />
                                <telerik:RadNumericTextBox ID="txt_valor_factura" runat="server"  Width="90%">
                                </telerik:RadNumericTextBox>
                            ...
                            <div class="col-sm-4">
                                ...
                                <br />
                                <telerik:RadComboBox ID="cmb_caracter" AutoPostBack="false" emptymessage="Seleccione..." Filter="Contains" runat="server" Width="90%">
                                    </telerik:RadComboBox>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-12">
                                ...
                                <br />
                                <telerik:RadTextBox CssClass="upper" ID="txt_observaciones" runat="server" Rows="3" TextMode="MultiLine" Width="97%" MaxLength="1000">
                                </telerik:RadTextBox>
                            </div>
