<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/Site.Master" CodeBehind="frm_facturacionAD.aspx.vb" Inherits="RMS_APPROVAL.frm_facturacionAD" %>
    ...
    <section class="content">
        <div class="box">
            <div class="box-header with-border">
                <h3 class="box-title">
                    <asp:Label runat="server" ID="lblt_subtitulo_pantalla">Registrar factura</asp:Label></h3>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-4">
                                ...
                                <asp:RequiredFieldValidator ID="RequiredFieldValidator8" runat="server"
                                            ...
                                            ErrorMessage="Campo obligatorio" ValidationGroup="1">*</asp:RequiredFieldValidator>
                                <br />
                                <asp:RegularExpressionValidator Display = "Dynamic" CssClass="Error" ControlToValidate = "txt_celular_" ID="RegularExpressionValidator2" ValidationExpression = "^[0-9]{10,10}$" runat="server" ErrorMessage="Número de celular incorrecto.">
