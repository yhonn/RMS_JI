<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/Site.Master" CodeBehind="frm_radicadosEdit.aspx.vb" Inherits="RMS_APPROVAL.frm_radicadosEdit" %>
                ...
                <div class="col-lg-12">
                    <div class="box-body">
                       ...
                       <div class="form-group row" runat="server" visible="false" id="subRegionVisible">
                        ...
                        <div class="form-group row" runat="server" visible="false" id="cambioEstado">
                            <div class="col-sm-4">
                                <asp:Label runat="server" ID="Label11" CssClass="control-label text-bold">Tipo de documento</asp:Label>
                                <br />
                                <telerik:RadComboBox ID="cmb_tipo_documento" AutoPostBack="false" emptymessage="Seleccione..." Filter="Contains" runat="server" Width="90%">
                                    </telerik:RadComboBox>
                            ...
                            <div class="col-sm-4">
                                <asp:Label runat="server" ID="Label4" CssClass="control-label text-bold">Estado</asp:Label>
                                <br />
                                <telerik:RadComboBox ID="cmb_estado" AutoPostBack="true" emptymessage="Seleccione..." Filter="Contains" runat="server" Width="90%">
                                    </telerik:RadComboBox>
                                <asp:RequiredFieldValidator ID="RequiredFieldValidator1" runat="server"
                                            ControlToValidate="cmb_estado" CssClass="Error" Display="Dynamic"
                                            ErrorMessage="Campo obligatorio" ValidationGroup="1">*</asp:RequiredFieldValidator>
                            </div>
                             <div class="col-sm-4" runat="server" visible="false" id="codigo_gj">
                             ...
                             <div class="col-sm-4" runat="server" visible="false" id="rechazo">
                                <asp:Label runat="server" ID="Label10" CssClass="control-label text-bold">Motivo de rechazo</asp:Label>
                                <br />
                                <telerik:RadTextBox CssClass="upper" ID="txt_motivo_rechazo" runat="server" Rows="3" TextMode="MultiLine" Width="90%" MaxLength="1000">
                                </telerik:RadTextBox>
                                <asp:RequiredFieldValidator ID="RequiredFieldValidator8" runat="server"
                                            ControlToValidate="txt_motivo_rechazo" CssClass="Error" Display="Dynamic"
                                            ErrorMessage="Campo obligatorio" ValidationGroup="1">*</asp:RequiredFieldValidator>
                            </div>
                        </div>
                        <div class="form-group row" runat="server" visible="false" id="anulaR">
                            <div class="col-sm-12">
                                <asp:Label runat="server" ID="Label12" CssClass="control-label text-bold">Motivo anula</asp:Label>
                                <br />
                                <telerik:RadTextBox CssClass="upper" ID="txt_motivo_anula" runat="server" Rows="3" TextMode="MultiLine" Width="97%" MaxLength="1000">
                                </telerik:RadTextBox>
                                <asp:RequiredFieldValidator ID="RequiredFieldValidator10" runat="server"
                                            ControlToValidate="txt_motivo_anula" CssClass="Error" Display="Dynamic"
                                            ErrorMessage="Campo obligatorio" ValidationGroup="1">*</asp:RequiredFieldValidator>
                            </div>
                        </div>
                    </div>
