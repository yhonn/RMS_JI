<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/Site.Master" CodeBehind="frm_tasa_ser.aspx.vb" Inherits="RMS_APPROVAL.frm_tasa_ser" %>
    ...
    <section class="content">
        <div class="box">
            <div class="box-header with-border">
                <div class="col-sm-6">   
                    <h3 class="box-title">
                        <asp:Label runat="server" ID="lblt_subtitulo_pantalla">Tasa SER</asp:Label>
                    </h3>                       
                </div>
            </div>
            <div class="box-body">
                ...
                <div class="form-group row">
                    <div class="col-sm-2 text-right">
                        <asp:Label runat="server" ID="Label2" CssClass="control-label text-bold text-right">Tasa SER</asp:Label>
                    </div>
                    <div class="col-sm-4">
                ...
                <div class="form-group row">
                    ...
                    <div class="col-sm-4">
                       <telerik:RadButton ID="btn_guardar" runat="server" AutoPostBack="true" Enabled="false" Text="Registrar tasa ser" ValidationGroup="1">
                        </telerik:RadButton>
                    </div>
                </div>
                <hr />
                   <div class="col-lg-12" style="width:100%; margin: 0 auto; margin-top:10px;">
                       <div style="max-width:100%; overflow-x:auto">
                          ...
                          <telerik:RadGrid RenderMode="Lightweight" AutoGenerateColumns="false" ID="grd_cate"   PageSize="15" 
                                ...
                                <MasterTableView AutoGenerateColumns="false" AllowFilteringByColumn="False" ShowFooter="False"  DataKeyNames="id_tasa_ser">
                                    <Columns>
                                        <telerik:GridBoundColumn DataField="id_tasa_ser"
                                            FilterControlAltText="Filter id_tasa_ser column"
                                            SortExpression="id_tasa_ser" UniqueName="id_tasa_ser"
                                            Visible="False" DataType="System.Int32" HeaderText="id_tasa_ser"
                                            ReadOnly="True">
