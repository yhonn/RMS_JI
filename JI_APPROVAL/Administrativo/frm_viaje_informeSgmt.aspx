<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/Site.Master" CodeBehind="frm_viaje_informeSgmt.aspx.vb" Inherits="RMS_APPROVAL.frm_viaje_informeSgmt" %>
                ...
                <div class="col-lg-12">
                    <div class="box-body">
                       ...
                       <div class="panel-group" id="accordion" role="tablist" aria-multiselectable="true">
                           ...
                           <div class="panel panel-default">
                               <div class="panel-heading" role="tab" id="infoInforme" data-toggle="collapse" data-parent="#accordion" href="#collapseInforme" aria-expanded="false" aria-controls="collapseInforme">
                                    <h4 class="panel-title">
                                        <a class="collapsed" role="button" data-toggle="collapse" href="#collapseInforme"
                                            aria-expanded="false" aria-controls="collapseInforme" runat="server" id="a3">Informe del viaje
                                        </a>
                                    </h4>
                                </div>
                               <div id="collapseInforme" class="panel-collapse collapse in" role="tabpanel" aria-labelledby="infoInforme">
                                    <div class="panel-body">
                                        <div class="form-group row">
                                            <div class="col-sm-12 col-md-12 col-lg-12">
                                            <asp:Label runat="server" ID="Label3" CssClass="control-label text-bold">Resultados:</asp:Label>
                                            <br />
                                            <asp:Label runat="server" ID="lblt_resultados" CssClass="control-label"></asp:Label>
                                            </div>
                                        </div>
                                        <div class="form-group row">
                                            <div class="col-sm-12 col-md-12 col-lg-12">
                                            <asp:Label runat="server" ID="Label2" CssClass="control-label text-bold">Actividades en el informe del viaje:</asp:Label>
                                            <br />
                                            <asp:Label runat="server" ID="lblt_conclusiones" CssClass="control-label"></asp:Label>
                                            </div>
                                        </div>
                                         <div class="form-group row">
                                            <div class="col-sm-12 col-md-12 col-lg-12">
                                            <asp:Label runat="server" ID="Label4" CssClass="control-label text-bold">Lugares visitados, entidades y personas con las cuáles se reunió:</asp:Label>
                                            <br />
                                            <asp:Label runat="server" ID="lblt_lugares_entidades_personas" CssClass="control-label"></asp:Label>
                                            </div>
                                        </div>
                                    </div>
                               </div>
