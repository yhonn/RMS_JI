<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/Site.Master" CodeBehind="frm_anticiposEdit.aspx.vb" Inherits="RMS_APPROVAL.frm_anticiposEdit" %>
                    ...
                    <div class="box-body">
                        ...
                        <div class="form-group row">
                            <div class="col-sm-6 col-md-6 col-lg-4" runat="server" visible="false" id="subRegionVisible">
                                ...
                                <br />
                                <telerik:radcombobox id="cmb_sub_Region" enabled="false" autopostback="true" emptymessage="Seleccione..." filter="Contains" runat="server" width="90%">
                                </telerik:radcombobox>
                        ...
                        <div class="form-group row">
                            <div class="col-sm-6 col-md-6 col-lg-4">
                                ...
                                <br />
                                <telerik:raddatepicker id="dt_fecha_anticipo" autopostback="true" width="90%" enabled="false" runat="server">
                            ...
                            <div class="col-sm-6 col-md-6 col-lg-4">
                                ...
                                <br />
                                <telerik:radcombobox id="cmb_medio_pago" autopostback="true" enabled="false" emptymessage="Seleccione..." runat="server" width="90%">
                                </telerik:radcombobox>
                        ...
                        <div class="form-group row">
                            <div class="col-sm-6 col-md-6 col-lg-4">
                                ...
                                <br />
                                <telerik:radcombobox id="cmb_tipo_anticipo" enabled="false" autopostback="true" emptymessage="Seleccione..." runat="server" width="90%">
                                </telerik:radcombobox>
                            ...
                            <div class="col-sm-6 col-md-6 col-lg-4">
                                ...
                                <br />
                                <telerik:radcombobox id="cmb_par" autopostback="true" enabled="false" emptymessage="Seleccione..." filter="Contains" runat="server" width="90%">
                                </telerik:radcombobox>
