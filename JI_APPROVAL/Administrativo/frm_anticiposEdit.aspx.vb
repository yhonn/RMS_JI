...
Imports ly_APPROVAL
Public Class frm_anticiposEdit
    Inherits System.Web.UI.Page
    Dim cnnSAP As New SqlConnection(ConnectionStrings("dbCI_SAPConnectionString").ConnectionString)
    Dim cl_user As ly_SIME.CORE.cls_user
    Dim cl_error As New ly_SIME.CORE.ErrorHandler
    Dim frmCODE As String = "ADM_ANTICIPOS_EDIT"
    ...
    Sub LoadData(ByVal id_anticipo As Integer)
        ...
        Using dbEntities As New dbRMS_JIEntities
            ...
            Me.txt_otro_medio_pago.Text = anticipo.otro_medio_pago
            Me.txt_detalle_medio_pago.Text = anticipo.observaciones_medio_pago
            Me.txt_costo_giro.Value = anticipo.costo_total_giro
            Me.cmb_tipo_anticipo.SelectedValue = anticipo.tme_pares.id_tipo_par
            loadPar()
            loadCiudaddes()
