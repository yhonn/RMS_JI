<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/Site.Master" CodeBehind="frm_parAD.aspx.vb" Inherits="RMS_APPROVAL.frm_parAD" %>
    ...
    <section class="content">
        <div class="box">
            <div class="box-header with-border">
                <h3 class="box-title">
                    <asp:Label runat="server" ID="lblt_subtitulo_pantalla">Registrar PAR</asp:Label></h3>
                                   ...
                                   <div class="col-sm-6 col-md-6 col-lg-3">
                                    ...
                                    <div class="col-sm-6 col-md-6 col-lg-">
                                        ...
                                        <telerik:RadGrid ID="grd_fuente_aporte" runat="server" AllowAutomaticDeletes="True"  CellSpacing="0" AllowPaging="True" PageSize="100" AutoGenerateColumns="False" Width="100%"
                                            ...
                                            <MasterTableView AutoGenerateColumns="False" DataKeyNames="id_aporte,id_par_fuente_aporte" AllowAutomaticUpdates="True" >
                                                <Columns>
