<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/Site.Master" CodeBehind="frm_par_permisos.aspx.vb" Inherits="RMS_APPROVAL.frm_par_permisos" %>
...
<%--
                                        ...
                                        <div class="form-group row">
                                            <div class="col-sm-12">
                                                <h4 class="text-center"><asp:Label runat="server" ID="Label8" CssClass="control-label text-bold">Historial</asp:Label></h4>
                                       ...
                                       <div class="form-group row">
                                            <div class="col-sm-12">
                                                <telerik:RadGrid ID="grd_historial_reversiones" runat="server" AllowAutomaticDeletes="True"  CellSpacing="0" AllowPaging="True" PageSize="100" AutoGenerateColumns="False" Width="100%"
                                                    ...
                                                    <MasterTableView AutoGenerateColumns="False" DataKeyNames="id_par_historial_permisos" AllowAutomaticUpdates="True" >
                                                        <Columns>
                                                            <telerik:GridBoundColumn DataField="id_par_historial_permisos"
                                                                FilterControlAltText="Filter id_par_historial_permisos column"
                                                                SortExpression="id_par_historial_permisos" UniqueName="id_par_historial_permisos"
                                                                Visible="False" HeaderText="id_par_historial_permisos"
                                                                ReadOnly="True">
                                                            </telerik:GridBoundColumn>
                                                            ...
                                                            <telerik:GridBoundColumn DataField="tipo_permiso"
                                                                FilterControlAltText="Filter tipo_permiso column" HeaderStyle-Width="23%"
                                                                HeaderText="Tipo de permiso" SortExpression="tipo_permiso"
                                                                UniqueName="tipo_permiso">
                                                                <HeaderStyle CssClass="wrapWord"  />
                                                            </telerik:GridBoundColumn>
                                                        </Columns>
                                                    </MasterTableView>
                                        ...
                                        <div class="form-group row">
                                         ...
                                         <div class="form-group row">
                                                 <div class="col-sm-12 col-md-12 col-lg-12">
                                                    <asp:Label runat="server" ID="Label1" CssClass="control-label text-bold">Motivo</asp:Label>
                                                    <br />
                                            ...
                                            <div class="form-group row">
                                                 <div class="col-sm-4 col-md-4 col-lg-4">
                                                    <asp:Label runat="server" ID="Label4" CssClass="control-label text-bold">Usuario solicita</asp:Label>
                                                    <br />
                                                ...
                                                <div class="col-sm-4 col-md-4 col-lg-4">
                                                    <asp:Label runat="server" ID="Label6" CssClass="control-label text-bold">Tipo de permiso</asp:Label>
                                                    <br />
                                        ...
                                        <div class="box-footer">
                                            ...
                                            <asp:Label ID="Label7" runat="server" CssClass="Error pull-right" Visible="False">* Complete campos</asp:Label>
                                        </div>
                                </div>
