<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/Site.Master" CodeBehind="frm_measurement_cat3.aspx.vb" Inherits="RMS_APPROVAL.frm_measurement_catgroup" %>
    ...
    <section class="content">
        <div class="box">
            <div class="box-header with-border">
                <h3 class="box-title">
                    <asp:Label runat="server" ID="lblt_subtitulo_pantalla">Group Category</asp:Label>
                    ...
                    <div class="box-body">
                        <div class="col-lg-12">
                            ...
                            <ul class="nav nav-tabs">
                                ...
                                <li role="presentation" class="active"><a runat="server" class="primary" id="alink_title">Group Category</a></li>
                                ...
                                <li role="presentation"><a runat="server" id="alink_survey_questions">Survey Questions</a></li>
                            </ul>
                        </div>
                        ...
                        <div class="panel-body div-bordered">
                            <div class="form-group row">
                                ...
                                <div class="col-sm-3 text-right">
                                    <asp:Label runat="server" ID="lblt_titles" CssClass="control-label text-bold">Group Category</asp:Label>
                                </div>
                                <div class="col-sm-8">
                                    <telerik:RadTextBox runat="server" ID="txt_title" Width="500px"></telerik:RadTextBox>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-8">
                                    <telerik:RadGrid ID="grd_titles" runat="server" AllowAutomaticDeletes="True"
                                        AllowPaging="True" AllowSorting="True" PageSize="15" AutoGenerateColumns="False">
                                        <MasterTableView AutoGenerateColumns="False" DataKeyNames="id_measurement_title" AllowAutomaticUpdates="True">
                                            <Columns>
                                                <telerik:GridBoundColumn DataField="id_measurement_title"
                                                    DataType="System.Int32"
                                                    FilterControlAltText="Filter id_measurement_title column"
                                                    HeaderText="id_measurement_title" ReadOnly="True"
                                                    SortExpression="id_measurement_title" UniqueName="id_measurement_title"
                                                    Visible="False">
                                                ...
                                                <telerik:GridTemplateColumn UniqueName="colm_delete">
                                                    ...
                                                    <ItemTemplate>
                                                        <asp:LinkButton ID="col_hlk_eliminar" runat="server" Width="10"
                                                            ...
                                                            OnClick="DeleteTitle_Click">
                                                            <asp:Image ID="img_eliminar" runat="server" ImageUrl="../Imagenes/iconos/b_drop.png" Style="border-width: 0px;" />
                                                        </asp:LinkButton>
                                                    </ItemTemplate>
                                                </telerik:GridTemplateColumn>

                                                <telerik:GridTemplateColumn FilterControlAltText="Filter colm_title_name column"
                                                    HeaderText="Group Category Name" UniqueName="colm_title_name">
                                                    <ItemTemplate>
                                                        <telerik:RadTextBox ID="txt_title" runat="server" Width="500px"></telerik:RadTextBox>
                                                    </ItemTemplate>
                                                    <HeaderStyle Width="550px" />
                                                </telerik:GridTemplateColumn>
                                                <telerik:GridBoundColumn DataField="title_name" FilterControlAltText="Filter title_name column"
                                                    HeaderText="Title_Name" SortExpression="title_name" UniqueName="title_name" Visible="false">
                                                </telerik:GridBoundColumn>
                                            </Columns>
                                        </MasterTableView>
                                    </telerik:RadGrid>
