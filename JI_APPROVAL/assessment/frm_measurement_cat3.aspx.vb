...
Public Class frm_measurement_catgroup
    Inherits System.Web.UI.Page

    Dim cl_user As ly_SIME.CORE.cls_user
    Dim frmCODE As String = "ASSESMENT_CAT3"
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        If Not Me.IsPostBack Then
            ...
            Using dbEntities As New dbRMS_JIEntities
                ...
                Me.grd_titles.DataSource = dbEntities.tme_measurement_title.ToList()
                Me.grd_titles.DataBind()
    ...
    Protected Sub DeleteTitle_Click(sender As Object, e As EventArgs)
    ...
    Protected Sub btn_deleteRegister_Click(sender As Object, e As EventArgs) Handles btn_deleteRegister.Click
        Using dbEntities As New dbRMS_JIEntities
            Try
                dbEntities.Database.ExecuteSqlCommand("DELETE FROM tme_measurement_title WHERE id_measurement_title = " + Me.identity.Text)
    ...
    Protected Sub btn_add_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles btn_add.Click
        'guardarIndicadores()
        Using dbEntities As New dbRMS_JIEntities
            Dim oTitle = New tme_measurement_title
            oTitle.title_name = Me.txt_title.Text
            dbEntities.tme_measurement_title.Add(oTitle)
    ...
    Protected Sub grd_titles_ItemDataBound(ByVal sender As Object, ByVal e As Telerik.Web.UI.GridItemEventArgs) Handles grd_titles.ItemDataBound
        If e.Item.ItemType = GridItemType.AlternatingItem Or e.Item.ItemType = GridItemType.Item Then
            ...
            Dim ThemeName As RadTextBox = CType(e.Item.Cells(0).FindControl("txt_title"), RadTextBox)
            ThemeName.Text = DataBinder.Eval(e.Item.DataItem, "title_name").ToString()
            ...
            hlnkDelete.Attributes.Add("data-href", DataBinder.Eval(e.Item.DataItem, "id_measurement_title").ToString())
            hlnkDelete.Attributes.Add("data-identity", DataBinder.Eval(e.Item.DataItem, "id_measurement_title").ToString())
        End If
    End Sub

    Protected Sub btn_guardar_Click(sender As Object, e As EventArgs) Handles btn_guardar.Click
        Dim sql As String = ""
        For Each row In Me.grd_titles.Items
            If TypeOf row Is GridDataItem Then
                Dim dataItem As GridDataItem = CType(row, GridDataItem)
                Dim IDInstrumentoID As Integer = dataItem.GetDataKeyValue("id_measurement_title")
                'Dim TotalIndicador As RadNumericTextBox = CType(row.Cells(0).FindControl("txt_value"), RadNumericTextBox)
                Dim SkillName As RadTextBox = CType(row.Cells(0).FindControl("txt_title"), RadTextBox)
                sql = "UPDATE tme_measurement_title SET title_name = '" & SkillName.Text & "'"
                sql &= " WHERE id_measurement_title= " & IDInstrumentoID.ToString
    ...
    Protected Sub grd_titles_PageIndexChanged(sender As Object, e As GridPageChangedEventArgs) Handles grd_titles.PageIndexChanged
        Using dbEntities As New dbRMS_JIEntities
            Me.grd_titles.DataSource = dbEntities.tme_measurement_title.ToList()
            Me.grd_titles.DataBind()
        End Using
    ...
    Protected Sub grd_skills_PageSizeChanged(sender As Object, e As GridPageSizeChangedEventArgs) Handles grd_titles.PageSizeChanged
        Using dbEntities As New dbRMS_JIEntities
            Me.grd_titles.DataSource = dbEntities.tme_measurement_title.ToList()
            Me.grd_titles.DataBind()
        End Using
