...
Public Class frm_measurement_cat1
    Inherits System.Web.UI.Page

    Dim cl_user As ly_SIME.CORE.cls_user
    Dim frmCODE As String = "ASSESMENT_CAT1"
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        If Not Me.IsPostBack Then
            ...
            Using dbEntities As New dbRMS_JIEntities
                ...
                Me.grd_themes.DataSource = dbEntities.tme_measurement_theme.ToList()
                Me.grd_themes.DataBind()
    ...
    Protected Sub DeleteTheme_Click(sender As Object, e As EventArgs)
    ...
    Protected Sub btn_deleteRegister_Click(sender As Object, e As EventArgs) Handles btn_deleteRegister.Click
        Using dbEntities As New dbRMS_JIEntities
            Try
                dbEntities.Database.ExecuteSqlCommand("DELETE FROM tme_measurement_theme WHERE id_measurement_theme = " + Me.identity.Text)
    ...
    Protected Sub btn_add_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles btn_add.Click
        ...
        If Me.txt_percent.Value <= 100 Then
            Using dbEntities As New dbRMS_JIEntities
                Dim oTheme = New tme_measurement_theme
                oTheme.theme_name = Me.txt_theme.Text
                oTheme.percent_value = Me.txt_percent.Value
                dbEntities.tme_measurement_theme.Add(oTheme)
                dbEntities.SaveChanges()

                'listaIndicadores()
            End Using
            Me.MsgGuardar.NuevoMensaje = cl_user.controles_otros.FirstOrDefault(Function(p) p.control_code = "GUARDADO").texto
            Me.MsgGuardar.Redireccion = "~/assessment/frm_measurement_cat1"
    ...
    Protected Sub grd_themes_ItemDataBound(ByVal sender As Object, ByVal e As Telerik.Web.UI.GridItemEventArgs) Handles grd_themes.ItemDataBound
        If e.Item.ItemType = GridItemType.AlternatingItem Or e.Item.ItemType = GridItemType.Item Then
            ...
            Dim ThemeName As RadTextBox = CType(e.Item.Cells(0).FindControl("txt_theme"), RadTextBox)
            ThemeName.Text = DataBinder.Eval(e.Item.DataItem, "theme_name").ToString()
            ...
            hlnkDelete.Attributes.Add("data-href", DataBinder.Eval(e.Item.DataItem, "id_measurement_theme").ToString())
            hlnkDelete.Attributes.Add("data-identity", DataBinder.Eval(e.Item.DataItem, "id_measurement_theme").ToString())
        End If
    End Sub
    ...
    Protected Sub btn_guardar_Click(sender As Object, e As EventArgs) Handles btn_guardar.Click
        ...
        For Each row In Me.grd_themes.Items
            If TypeOf row Is GridDataItem Then
                Dim dataItem As GridDataItem = CType(row, GridDataItem)
                Dim IDInstrumentoID As Integer = dataItem.GetDataKeyValue("id_measurement_theme")
                Dim TotalIndicador As RadNumericTextBox = CType(row.Cells(0).FindControl("txt_value"), RadNumericTextBox)
                Dim ThemeName As RadTextBox = CType(row.Cells(0).FindControl("txt_theme"), RadTextBox)
                sql = "UPDATE tme_measurement_theme SET percent_value =" & TotalIndicador.Value & ", theme_name = '" & ThemeName.Text & "'"
                sql &= " WHERE id_measurement_theme= " & IDInstrumentoID.ToString
    ...
    Protected Sub grd_themes_PageIndexChanged(sender As Object, e As GridPageChangedEventArgs) Handles grd_themes.PageIndexChanged
        Using dbEntities As New dbRMS_JIEntities
            Me.grd_themes.DataSource = dbEntities.tme_measurement_theme.ToList()
            Me.grd_themes.DataBind()
        End Using
    ...
    Protected Sub grd_themes_PageSizeChanged(sender As Object, e As GridPageSizeChangedEventArgs) Handles grd_themes.PageSizeChanged
        Using dbEntities As New dbRMS_JIEntities
            Me.grd_themes.DataSource = dbEntities.tme_measurement_theme.ToList()
            Me.grd_themes.DataBind()
        End Using
