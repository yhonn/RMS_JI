...
Partial Public Class frm_measurement_surveys
    ...
    '''Para modificarlo, mueva la declaración del campo del archivo del diseñador al archivo de código subyacente.
    '''</remarks>
    Protected WithEvents txt_survey As Global.Telerik.Web.UI.RadTextBox
    ...
    '''Para modificarlo, mueva la declaración del campo del archivo del diseñador al archivo de código subyacente.
    '''</remarks>
    Protected WithEvents grd_surveys As Global.Telerik.Web.UI.RadGrid
